...
export const TEXTOS = {
  ...
  'marca.sub': 'Dom Umysłu OS',
  'nav.entrar': 'Zaloguj się',
  'nav.descargar': 'Pobierz',
  'pie.inicio': 'Start',
  'pie.privacidad': 'Prywatność',
  ...
  'como.sub': 'Przestrzeń, w której najpierw stawiasz MindHaOS (Dom Umysłu OS), a potem wprowadzasz do niego swoje życie.',
  'como.1.t': 'Stawiasz swój MindHaOS',
  'como.1.p':
  ...
  'como.3.p':
    '17 aplikacji i cztery ze Studia dzielą jeden kalendarz, jedną listę codziennych misji i twoje osobiste cele. A cały MindHaOS (Dom Umysłu OS) idzie z tobą z telefonu na komputer.',

  'car.h2': 'Jeden MindHaOS, wiele aplikacji',
  ...
  'car.5.t': 'Kalendarz i cele',
  'car.5.p':
    'Rutyny na 24 godziny, cele zagnieżdżone, harmonogramy tworzone przez SI i wskaźniki realizacji, które naprawdę da się zrozumieć.',
  'car.6.t': 'Twoje dane, przy tobie',
  'car.6.p':
  ...
  'ia.sub':
    'SI w MindHaOS zapisuje, planuje i tworzy razem z tobą. A ty decydujesz, co ją napędza: dostawca w chmurze albo twój własny komputer.',
  ...
  'ia.cap.3.p': 'Zilustruj swoje przepisy, ubrania i pomysły oraz zbuduj nowe meble i obiekty do MindHaOS.',
  ...
  'ia.local.p':
    'Zainstaluj Ollamę, a MindHaOS porozmawia z modelem działającym na twoim komputerze: bez kredytów, bez połączenia i bez tego, żeby cokolwiek stąd wyszło.',
  ...
  'mani.p1':
    'MindHaOS to twoje życie zamienione w grę wideo, w którą grasz z najwygodniejszego miejsca na świecie: z własnego MindHaOS. Poziomy i rangi nie są ozdobą — to twoje sprawy z zewnątrz, opowiedziane tutaj, w środku.',
  'mani.p2':
  ...
  'priv.titulo': 'Polityka prywatności',
  ...
  'priv.datos.2':
    '<strong>Dane aplikacji:</strong> to, co zapisujesz w swoich pokojach (rutyny, posiłki, finanse, notatki, zdjęcia…). Żyją najpierw na twoim urządzeniu, a przy włączonej synchronizacji są szyfrowane w przesyle i synchronizowane z naszymi serwerami, żeby dom szedł z tobą między urządzeniami.',
  'priv.datos.3':
  ...
  'term.contacto.p':
    'Pytania i wsparcie: <a href="mailto:mindplannerhome@gmail.com">mindplannerhome@gmail.com</a> · <a href="tel:5510132542">55 1013 2542</a>.',

  // ── Soporte (web/soporte.html) ──
  'pie.soporte': 'Wsparcie',
  'sop.titulo': 'Wsparcie',
  'sop.p': 'Jeśli coś nie działa albo masz pytanie, napisz do nas — odpowiemy najszybciej, jak się da.',
  'sop.correo.h': 'Napisz do nas',
  'sop.datos.h': 'Co zawrzeć w wiadomości',
  'sop.datos.1': 'Twoje urządzenie i system (na przykład: Android 14, iPhone 15, Windows 11).',
  'sop.datos.2': 'Co robiłeś(-aś), gdy pojawił się problem.',
  'sop.datos.3': 'Zrzut ekranu, jeśli się da.',
  'sop.faq.h': 'Częste pytania',
