...
export const TEXTOS = {
  ...
  'como.sub': 'A place where you build your MindHaOS and then move your life into it.',
  'como.1.t': 'You build your MindHaOS',
  'como.1.p':
  ...
  'como.3.p':
    'The 17 apps and the four in the Studio share one calendar, one list of daily missions and your own personal goals. And your whole MindHaOS follows you from phone to computer.',

  'car.h2': 'One MindHaOS, many apps',
  ...
  'car.studio.t': 'A Studio for creating',
  'car.studio.p':
  ...
  'car.5.t': 'Calendar and goals',
  'car.5.p':
    '24-hour routines, nested goals, AI-built timelines and completion metrics that actually make sense.',
  'car.6.t': 'Your data, with you',
  'car.6.p':
  ...
  'ia.cap.3.p':
    'Illustrate your recipes, your clothes and your ideas, and build new furniture and objects for your MindHaOS.',
  ...
  'ia.local.p':
    'Install Ollama and your MindHaOS talks to the model running on your computer: no credits, no connection and nothing leaves it.',
  ...
  'mani.p1':
    'MindHaOS is your life rendered as a video game, played from the most comfortable place there is: your own MindHaOS. Leveling up and earning ranks is not decoration — it is what you did out there, told in here.',
  'mani.p2':
  ...
  'priv.datos.2':
    '<strong>App data:</strong> whatever you record in your rooms (routines, meals, finances, notes, photos…). It lives on your device first and, with sync on, is synchronised encrypted in transit with our servers so that your house follows you between devices.',
  'priv.datos.3':
  ...
  'term.contacto.p':
    'Questions and support: <a href="mailto:mindplannerhome@gmail.com">mindplannerhome@gmail.com</a> · <a href="tel:5510132542">55 1013 2542</a>.',

  // ── Soporte (web/soporte.html) ──
  'pie.soporte': 'Support',
  'sop.titulo': 'Support',
  'sop.p': 'If something isn’t working or you have a question, write to us and we’ll get back to you as soon as we can.',
  'sop.correo.h': 'Write to us',
  'sop.datos.h': 'What to include in your message',
  'sop.datos.1': 'Your device and system (for example: Android 14, iPhone 15, Windows 11).',
  'sop.datos.2': 'What you were doing when the problem appeared.',
  'sop.datos.3': 'A screenshot, if possible.',
  'sop.faq.h': 'Frequently asked questions',
