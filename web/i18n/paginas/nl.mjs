...
export const TEXTOS = {
  ...
  'pie.terminos': 'Voorwaarden',
  'pie.cuenta': 'Mijn account',
  ...
  'car.5.t': 'Agenda en doelen',
  'car.5.p':
    'Routines over 24 uur, geneste doelen, planningen van de AI en cijfers over wat je haalt die echt te begrijpen zijn.',
  'car.6.t': 'Je gegevens, bij jou',
  'car.6.p':
  ...
  'priv.datos.2':
    '<strong>Appgegevens:</strong> wat je in je kamers vastlegt (routines, maaltijden, financiën, notities, foto’s…). Ze leven eerst op je apparaat en worden, met synchronisatie aan, versleuteld onderweg gesynchroniseerd met onze servers zodat je huis je tussen apparaten volgt.',
  'priv.datos.3':
