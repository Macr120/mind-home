/** Textos de las páginas estáticas en portugués (pt-BR). Traducción de `es.mjs`. */
export const TEXTOS = {
  ...
  'pie.inicio': 'Início',
  'pie.privacidad': 'Privacidade',
  'pie.terminos': 'Termos',
  'pie.cuenta': 'Minha conta',
  'pie.contacto': 'Contato',
  'tema.boton': 'Modo claro ou escuro',

  'meta.titulo': 'Mind Planner Home — Sua mente, em uma casa 3D',
  'meta.desc':
    'Organize seus hábitos, metas, finanças, refeições e mais em uma casa isométrica 3D onde cada cômodo é um app. Um único pagamento de 8,89 USD com o primeiro mês de IA e sincronização incluído; demo grátis.',
  'og.desc':
    'Sua vida, em uma casa 3D: hábitos, metas, finanças, refeições e mais. Um pagamento de 8,89 USD com o primeiro mês de IA incluído; demo grátis.',
  ...
  'hero.sub.1': 'É um espaço onde você cria uma casa inserindo',
  'hero.sub.ej1.1': 'uma cozinha ou uma horta',
  'hero.sub.ej1.2': 'um escritório ou uma quadra',
  'hero.sub.ej1.3': 'uma biblioteca ou um circuito',
  'hero.sub.ej1.4': 'um jardim ou uma fazenda',
  'hero.sub.2': 'e em cada cômodo integra um app completo, como o de',
  'hero.sub.ej2.1': 'nutrição',
  'hero.sub.ej2.2': 'finanças',
  'hero.sub.ej2.3': 'aprendizado',
  'hero.sub.ej2.4': 'calma',
  'hero.sub.3': 'para arquivar, planejar ou criar suas',
  'hero.sub.ej3.1': 'refeições, macros e receitas',
  'hero.sub.ej3.2': 'orçamentos e metas de poupança',
  'hero.sub.ej3.3': 'anotações e sessões de estudo',
  'hero.sub.ej3.4': 'meditações e agradecimentos',
  'hero.sub.4':
  ...
  'hero.demo': 'Testar a demo grátis',
  'hero.nota':
    'O app é grátis e funciona sem conexão; a casa se compra uma vez — aqui na web ou dentro do app. A IA e a sincronização são opcionais — e se você deixar, não perde nada.',
  'hero.video': 'Aqui vai seu vídeo ou capturas da casa',
  ...
  'como.h2': 'Como funciona',
  'como.sub': 'Um espaço onde você levanta sua casa e depois coloca sua vida dentro dela.',
  'como.1.t': 'Você levanta sua casa',
  'como.1.p':
  ...
  'car.nocaduca.p':
    'Você compra uma vez e é seu. Os apps de assinatura desligam assim que você para de pagar; aqui, se largar a IA, fica com a casa inteira e todos os seus dados no seu dispositivo.',
  'car.nuevas.t': 'Atualizações novas',
  'car.nuevas.p': 'A casa continua crescendo: cômodos, apps e melhorias que chegam sem pagar de novo.',
  ...
  'car.3.p':
    'Sua casa acompanha você no celular, no tablet e no computador. Tudo criptografado em trânsito e com backup na nuvem.',
  ...
  'car.5.t': 'Calendário e metas',
  'car.5.p':
    'Rotinas de 24 horas, metas aninhadas, cronogramas com IA e métricas de cumprimento que dá para entender.',
  'car.6.t': 'Seus dados, com você',
  'car.6.p':
    'O app é local-first: tudo vive primeiro no seu dispositivo. Se você cancelar, não perde seus dados — continua no modo local.',
  ...
  'ia.h2': 'Seu assistente, com ou sem nuvem',
  'ia.sub':
    'A IA da casa registra, planeja e cria com você. E você decide quem a move: um provedor na nuvem ou o seu próprio computador.',
  'ia.cap.1.t': 'Registre falando',
  'ia.cap.1.p': 'Conte o que comeu, gastou ou treinou e ela anota no cômodo certo, com os campos e a data.',
  'ia.cap.2.t': 'Planeje suas metas',
  'ia.cap.2.p':
    'Você pede uma meta e ela propõe o cronograma: passos, datas e missões diárias que depois você edita na mão.',
  'ia.cap.3.t': 'Crie imagens e objetos 3D',
  'ia.cap.3.p': 'Ilustre suas receitas, suas roupas e suas ideias, e fabrique móveis e objetos novos para a sua casa.',
  'ia.cap.4.t': 'Fala e escuta você',
  'ia.cap.4.p': 'Seus assistentes respondem com voz, e o ditado deixa você registrar o dia sem escrever uma palavra.',
  'ia.nube.t': 'Na nuvem, com quem você escolher',
  'ia.nube.p':
    'Claude, Gemini ou ChatGPT: você escolhe quem pensa, quem fala e quem desenha. Com os créditos do seu plano ou com suas próprias chaves.',
  'ia.local.t': 'Ou na sua máquina, com o Ollama',
  'ia.local.p':
    'Instale o Ollama e a casa conversa com o modelo que roda no seu computador: sem créditos, sem conexão e sem que nada saia dali.',
  'ia.local.nota':
    'A voz e as imagens ainda precisam de um provedor na nuvem, a não ser que o seu modelo local saiba gerá-las.',

  'mani.h2': 'Sua vida, virada videogame',
  'mani.p1':
    'O MPH é a representação da sua vida transformada em videogame, jogada do lugar mais confortável que existe: a sua própria casa. Subir de nível e ganhar patentes não é enfeite — é o que você fez lá fora, contado aqui dentro.',
  'mani.p2':
  ...
  'precio.h2': 'Um único pagamento na loja, sua casa para sempre',
  'precio.demo.nombre': 'Demo',
  'precio.demo.cifra': 'Grátis',
  'precio.demo.1': 'A casa de Pep@ com um ano de vida dentro: teste tudo',
  'precio.demo.2': 'Sem conta, sem cartão e sem conexão',
  'precio.demo.3': 'Nada é salvo: ao recarregar, a casa começa de novo',
  'precio.demo.cta': 'Testar a demo',
  'precio.demo.pie': 'O app completo, para conhecer sem compromisso.',
  ...
  'desc.sub':
    'Baixe de graça e compre a casa dentro do app — ou aqui na web. Com a sua conta, a sua casa aparece em qualquer outro lugar, inclusive no navegador.',
  'desc.pronto': 'Em breve',
  'desc.android': 'Grátis no Google Play. A casa se compra dentro.',
  'desc.ios.t': 'iPhone e iPad',
  'desc.ios': 'Grátis na App Store. A casa se compra dentro.',
  'desc.web.t': 'No seu navegador',
  'desc.web':
    'Sem instalar nada: entre com a sua conta e a sua casa está à espera. Sem conta você pode experimentar a demo.',
  ...
  'faq.1.a':
    'Onde você preferir: aqui na web, em <a href="/cuenta">sua conta</a>, ou dentro do app de Android e iPhone. É um pagamento único guardado na sua conta, então, compre onde comprar, a sua casa aparece em todos os seus dispositivos.',
  'faq.2.q': 'O que inclui o pagamento único?',
  'faq.2.a':
    'A casa inteira: todos os cômodos, todos os apps e seus dados no seu dispositivo, para sempre e sem renovações. Além disso, o primeiro mês traz 700 créditos de IA e a sincronização incluídos, sem cartão. Antes de comprar você pode testar a demo completa, que não pede conta.',
  ...
  'faq.7.a':
    'Hoje: em qualquer navegador moderno. Em breve: Android (Google Play), iPhone/iPad (App Store), Windows e macOS. A sua conta vale para todos: você compra uma vez, onde for melhor, e tanto a casa quanto a assinatura de IA funcionam em qualquer dispositivo em que entrar com o seu e-mail.',
  ...
  'priv.quienes.p':
    'Mind Planner Home («o app») é um aplicativo de organização pessoal. Contato: <a href="mailto:mindplannerhome@gmail.com">mindplannerhome@gmail.com</a> · <a href="tel:5510132542">55 1013 2542</a>.',
  ...
  'priv.datos.2':
    '<strong>Dados do app:</strong> o que você registra nos seus cômodos (rotinas, refeições, finanças, notas, fotos…). Vivem primeiro no seu dispositivo e, com a sincronização ativa, são sincronizados criptografados em trânsito com nossos servidores para que sua casa acompanhe você entre dispositivos.',
  'priv.datos.3':
    '<strong>Pagamentos:</strong> processados por RevenueCat e Stripe. Nunca vemos nem armazenamos seu cartão; recebemos apenas o estado da sua compra e da sua assinatura.',
  'priv.datos.4':
    '<strong>Uso de IA:</strong> contadores de créditos consumidos (não o conteúdo das suas conversas, que é enviado aos provedores de IA unicamente para gerar cada resposta e não é usado para treinar).',
  'priv.datos.5':
  ...
  'term.servicio.p':
    'Mind Planner Home é um app de organização pessoal. A demo é gratuita e não exige conta. O app se compra com um pagamento único; as funções recorrentes (créditos de IA e sincronização) contratam-se unicamente nesta página web; os apps de desktop e de loja são clientes dessa mesma conta.',
  ...
  'term.app.3': 'A demo gratuita não guarda nada: é para conhecer o app antes de comprá-lo.',
  ...
  'term.contacto.h': 'Contato',
  'term.contacto.p':
    'Dúvidas e suporte: <a href="mailto:mindplannerhome@gmail.com">mindplannerhome@gmail.com</a> · <a href="tel:5510132542">55 1013 2542</a>.',

  // ── Soporte (web/soporte.html) ──
  'pie.soporte': 'Suporte',
  'sop.titulo': 'Suporte',
  'sop.p': 'Se algo não funciona ou você tem uma dúvida, escreva para a gente e respondemos o quanto antes.',
  'sop.correo.h': 'Escreva para a gente',
  'sop.datos.h': 'O que incluir na sua mensagem',
  'sop.datos.1': 'Seu dispositivo e sistema (por exemplo: Android 14, iPhone 15, Windows 11).',
  'sop.datos.2': 'O que você estava fazendo quando o problema apareceu.',
  'sop.datos.3': 'Uma captura de tela, se possível.',
  'sop.faq.h': 'Perguntas frequentes',
