...
export const TEXTOS = {
  ...
  'como.sub': 'Un espace où tu construis ta MindHaOS (Maison Mentale OS), puis où tu installes ta vie dedans.',
  'como.1.t': 'Tu construis ta MindHaOS',
  'como.1.p':
  ...
  'como.3.p':
    'Les 17 apps et les quatre du Studio partagent un calendrier, une liste de missions quotidiennes et tes objectifs personnels. Et ta MindHaOS (Maison Mentale OS) entière te suit du téléphone à l’ordinateur.',

  'car.h2': 'Une MindHaOS, plein d’apps',
  ...
  'car.3.p':
    'Ta MindHaOS te suit sur le téléphone, la tablette et l’ordinateur. Tout est chiffré en transit et sauvegardé dans le cloud.',
  'car.4.t': 'Ça se joue comme un jeu',
  'car.4.p':
    'Ton personnage vit de ton activité réelle : séries, badges, la Montagne de Sisyphe, véhicules, courses et mini-jeux.',
  'car.5.t': 'Calendrier et objectifs',
  'car.5.p':
    'Routines sur 24 heures, objectifs imbriqués, plannings générés par l’IA et des indicateurs de suivi qui se comprennent vraiment.',
  'car.6.t': 'Tes données, avec toi',
  'car.6.p':
  ...
  'ia.cap.3.p':
    'Illustre tes recettes, tes vêtements et tes idées, et fabrique de nouveaux meubles et objets pour ta MindHaOS.',
  ...
  'ia.local.p':
    'Installe Ollama et la MindHaOS parle au modèle qui tourne sur ton ordinateur : sans crédits, sans connexion et sans que rien n’en sorte.',
  'ia.local.nota':
  ...
  'mani.p1':
    'MindHaOS, c’est la représentation de ta vie transformée en jeu vidéo, jouée depuis l’endroit le plus confortable qui soit : ta propre MindHaOS. Monter de niveau et gagner des rangs n’est pas un ornement — c’est ce que tu as fait dehors, raconté ici.',
  'mani.p2':
  ...
  'priv.datos.2':
    '<strong>Données de l’app :</strong> ce que tu enregistres dans tes pièces (routines, repas, finances, notes, photos…). Elles vivent d’abord sur ton appareil et, avec la synchronisation active, sont synchronisées chiffrées en transit avec nos serveurs pour que ta maison te suive d’un appareil à l’autre.',
  'priv.datos.3':
  ...
  'term.precio.2':
    'Il comprend 700 crédits d’IA par mois et par niveau (700 / 1400 / 2100) et la synchronisation entre appareils. Les crédits mensuels non utilisés ne se reportent pas au mois suivant.',
  'term.precio.3':
  ...
  'term.cancelacion.p':
    'Tu peux résilier quand tu veux depuis « Gérer l’abonnement » dans <a href="/cuenta">ton compte</a> ; tu gardes la formule jusqu’à la fin de la période payée. Ensuite, l’app continue de fonctionner sur tes appareils en mode local, sans crédits mensuels ni synchronisation. Les crédits de recharge qu’il te reste demeurent utilisables, et tu peux reprendre quand tu veux.',
