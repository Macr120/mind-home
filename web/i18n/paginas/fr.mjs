...
export const TEXTOS = {
  ...
  'car.3.p':
    'Ta maison te suit sur le téléphone, la tablette et l’ordinateur. Tout est chiffré en transit et sauvegardé dans le cloud.',
  ...
  'term.app.1':
    'Déverrouillage de l’app : 6,99 USD, paiement unique. Il déverrouille ta maison pour toujours sur ton compte, sans renouvellements.',
  'term.app.2':
