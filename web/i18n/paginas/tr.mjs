...
export const TEXTOS = {
  ...
  'car.5.t': 'Takvim ve hedefler',
  'car.5.p':
    '24 saatlik rutinler, iç içe hedefler, yapay zekâ ile kurulan zaman çizelgeleri ve gerçekten anlaşılan tamamlanma ölçüleri.',
  'car.6.t': 'Verin, yanında',
  'car.6.p':
  ...
  'priv.datos.2':
    '<strong>Uygulama verileri:</strong> odalarına kaydettiklerin (rutinler, öğünler, finans, notlar, fotoğraflar…). Önce cihazında yaşarlar ve eşitleme açıkken, evin cihazlar arasında seni takip edebilsin diye aktarımda şifrelenerek sunucularımızla eşitlenir.',
  'priv.datos.3':
  ...
  'term.app.1':
    'Uygulamanın kilidinin açılması: 6,99 USD, tek ödeme. Hesabında evini sonsuza dek açar, yenileme yoktur.',
  'term.app.2':
