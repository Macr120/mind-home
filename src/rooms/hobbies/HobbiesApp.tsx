  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <button
        ...
        className="ui-accent-bg w-full rounded-lg py-2 font-bold hover:brightness-110 transition"
      >
            ...
            return (
              <li key={h.id}>
                <button
                  ...
                  className="flex w-full items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-start hover:bg-white/10 transition"
                >
                  <span
