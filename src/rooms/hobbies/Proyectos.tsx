...
import { proyectosHobbyRepo, sesionesHobbyRepo } from '../../core/data/repository'
...
export function Proyectos({
  ...
  // Las sesiones del proyecto se desvinculan antes de borrarlo (no se pierden registros).
        ...
        <ul className="space-y-1.5">
          {ordenados.map((p) => {
            ...
            return (
              ...
              >
                <span className="shrink-0"><Icono nombre={p.estado === 'terminado' ? 'hecho' : 'herramienta'} /></span>
                <div className="min-w-0 flex-1">
                  <p className={`truncate font-semibold ${p.estado === 'terminado' ? 'line-through' : ''}`}>
                    {p.nombre}
                  </p>
