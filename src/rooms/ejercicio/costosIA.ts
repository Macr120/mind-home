...
/**
 * Lo que cuesta la IA en Ejercicio. Las rutinas se arman a mano desde el
 * catálogo: aquí la IA solo ILUSTRA los ejercicios (y el planificador ✨ de
 * metas, que es del núcleo). El lote es la operación más cara de toda la app —
 * un grupo de 20 ejercicios son 20 imágenes de una sentada.
 */
...
export const OPERACIONES_IA: OperacionIA[] = [OP_IMAGEN_EJERCICIO, OP_LOTE_IMAGENES]
