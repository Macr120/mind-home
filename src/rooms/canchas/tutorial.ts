...
export const tutorialCanchas: TutorialDef = {
  ...
  resumen: T(
    ...
    'Canchas coloca canchas de fútbol, tenis y básquet sobre el mapa: eliges el deporte, el color del piso y el tamaño, y un fantasma te muestra dónde va a caer antes de soltarla. En modo Editar tocas una cancha ya puesta para cambiarle color, tamaño y rotación, o quitarla. Después, al entrar caminando a una cancha empieza el minijuego: solo o contra un asistente, con dificultad y marcador.',
  ),
  ...
  pasos: [
    ...
    },
    {
      ...
      texto: T(
        ...
        'Fútbol, tenis o básquet. Al elegir uno, un fantasma de la cancha sigue tu cursor por el mapa: el toque la coloca ahí.',
      ),
    },
    {
