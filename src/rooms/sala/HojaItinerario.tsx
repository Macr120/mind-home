    ...
    <div data-tut="sala.pc.hoja" className="space-y-2">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <p className="w-full text-[10px] leading-tight text-white/35">
          {t('sala.hoja.sync', 'Los días con fecha aparecen en el calendario de la MindHaOS y el total se vuelve una meta de ahorro en Finanzas. El plan se conserva aunque ya visites el lugar; solo desaparece si lo borras.')}
        </p>
      </div>
    </div>
  )
