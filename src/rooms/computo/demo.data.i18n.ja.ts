/**
 * Rama «ja» del año demo de computo. Solo se descarga si el usuario
 * está en ese idioma (el índice `demo.data.i18n.ts` la carga con import()).
 *
 * Las frases se traducen en `traducciones/computo.ja.json`; este
    ...
    },
    {
      ...
      "formulas": [
        ...
        },
        {
          ...
          "descripcion": "自分の体重を固定値にして、走っている自分のために計算することがほとんどです。",
          "variables": [
            {
              "simbolo": "m",
              "nombre": "質量",
      ...
      "formulas": [
        {
          ...
          "resultado": "costo",
          "descripcion": "時間を除いて、1杯を出すのにかかる費用です。",
          "variables": [
            {
              "simbolo": "precioKg",
              "nombre": "コーヒー1kgの価格",
        ...
        },
        {
          ...
          "resultado": "margen",
          "tex": "利益率 = \\dfrac{価格 - 原価}{価格} \\times 100",
          "variables": [
            {
              "simbolo": "pv",
              "nombre": "販売価格",
    ...
    },
    {
      ...
      "formulas": [
        ...
        },
        {
          ...
          "resultado": "VO2",
          "tex": "VO_{2}\\,max \\approx 15.3\\,\\dfrac{HR_{最大}}{HR_{安静時}}",
          "descripcion": "ウスの式です。大まかですが、自分が上達しているかを見るのには十分です。",
          "variables": [
            {
              "simbolo": "fcmax",
              "nombre": "最大心拍数",
