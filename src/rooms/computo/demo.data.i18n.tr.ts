/**
 * Rama «tr» del año demo de computo. Solo se descarga si el usuario
 * está en ese idioma (el índice `demo.data.i18n.ts` la carga con import()).
 *
 * Las frases se traducen en `traducciones/computo.tr.json`; este
  ...
  "carpetas": [
      ...
      "formulas": [
        {
          ...
          "variables": [
            {
              "simbolo": "x0",
              "nombre": "başlangıç konumu",
              "unidad": "m",
              "valor": 0
            },
            {
              "simbolo": "v0",
              "nombre": "başlangıç hızı",
              "unidad": "m/s",
              "valor": 0
            },
            {
        ...
        },
        {
          ...
          "nombre": "Torricelli (zamansız hız)",
        ...
        },
        {
          ...
          "nombre": "Kinetik enerji",
          "expresion": "m * v^2 / 2",
          "resultado": "Ek",
          "tex": "E_{k} = \\tfrac{1}{2}m\\,v^{2}",
          "descripcion": "Kendi kütlem sabit: çoğunlukla koşarken kendim için hesaplıyorum.",
          "variables": [
            {
              "simbolo": "m",
              "nombre": "kütle",
        ...
        },
        {
          ...
          "nombre": "Basit sarkacın periyodu",
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-costo-taza",
          "nombre": "Fincan başına maliyet",
          "expresion": "precioKg / 1000 * gramos + leche + vaso",
          "resultado": "costo",
          "descripcion": "Bir fincan servis etmenin maliyeti, zamanımı saymadan.",
          "variables": [
            {
              "simbolo": "precioKg",
              "nombre": "kilogram başına kahve fiyatı",
              "unidad": "$",
              "valor": 420
            },
            {
              "simbolo": "gramos",
              "nombre": "fincan başına gram",
              "unidad": "g",
              "valor": 18
            },
            {
        ...
        {
          "id": "demo-margen",
          "nombre": "Fiyat üzerinden kâr marjı",
          "expresion": "(pv - costo) / pv * 100",
          "resultado": "margen",
          "tex": "marj = \\dfrac{fiyat - maliyet}{fiyat} \\times 100",
          "variables": [
            {
              "simbolo": "pv",
              "nombre": "satış fiyatı",
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-ritmo",
          "nombre": "Kilometre başına tempo",
          "expresion": "minutos / km",
          "resultado": "ritmo",
          "tex": "tempo = \\dfrac{dakika}{km}",
          "variables": [
            {
              "simbolo": "minutos",
              "nombre": "toplam dakika",
              "unidad": "min",
              "valor": 58
            },
            {
        ...
        },
        {
          ...
          "nombre": "Maraton hedefi için tempo",
          "expresion": "metaMin / 42.195",
          "resultado": "paso",
          "variables": [
            {
              "simbolo": "metaMin",
              "nombre": "dakika cinsinden hedef",
              "unidad": "min",
              "valor": 240
            }
          ],
        ...
        {
          "id": "demo-vo2",
          "nombre": "Yaklaşık VO₂ maks",
          "expresion": "15.3 * fcmax / fcrep",
          "resultado": "VO2",
          "tex": "VO_{2}\\,maks \\approx 15.3\\,\\dfrac{Nb_{maks}}{Nb_{istirahat}}",
          "descripcion": "Uth formülü: kaba bir tahmin ama gelişip gelişmediğimi görmek için yeterli.",
          "variables": [
            {
              "simbolo": "fcmax",
              "nombre": "maksimum nabız",
              "unidad": "atım/dk",
              "valor": 189
            },
            {
              "simbolo": "fcrep",
              "nombre": "istirahat nabzı",
              "unidad": "atım/dk",
              "valor": 52
            }
          ],
