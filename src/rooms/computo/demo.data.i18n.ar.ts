/**
 * Rama «ar» del año demo de computo. Solo se descarga si el usuario
 * está en ese idioma (el índice `demo.data.i18n.ts` la carga con import()).
 *
 * Las frases se traducen en `traducciones/computo.ar.json`; este
...
export default {
  "carpetas": [
    ...
    {
      "id": "demo-parciales",
      "nombre": "الاختبارات النصفية",
      "emoji": "📐",
      "padre": "demo-fisica",
      "formulas": [
        {
          "id": "cat-fisica-mrua-posicion",
          "nombre": "الموضع مع التسارع الثابت",
          ...
          "variables": [
            {
              "simbolo": "x0",
              "nombre": "الموضع الابتدائي",
              "unidad": "m",
              "valor": 0
            },
            {
              "simbolo": "v0",
              "nombre": "السرعة الابتدائية",
              "unidad": "m/s",
              "valor": 0
            },
            {
        ...
        },
        {
          ...
          "nombre": "توريتشيلي (السرعة بدون زمن)",
        ...
        },
        {
          ...
          "nombre": "الطاقة الحركية",
          "expresion": "m * v^2 / 2",
          "resultado": "Ek",
          "tex": "E_{k} = \\tfrac{1}{2}m\\,v^{2}",
          "descripcion": "بكتلتي الثابتة: أحسبها غالبًا لنفسي أثناء الجري.",
          "variables": [
            {
              "simbolo": "m",
              "nombre": "الكتلة",
        ...
        },
        {
          ...
          "nombre": "الدور الزمني للبندول البسيط",
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-costo-taza",
          "nombre": "التكلفة لكل كوب",
          "expresion": "precioKg / 1000 * gramos + leche + vaso",
          "resultado": "costo",
          "descripcion": "تكلفة تقديم كوب واحد، بدون احتساب الوقت.",
          "variables": [
            {
              "simbolo": "precioKg",
              "nombre": "سعر كيلوغرام القهوة",
              "unidad": "$",
              "valor": 420
            },
            {
              "simbolo": "gramos",
              "nombre": "غرامات لكل كوب",
              "unidad": "g",
              "valor": 18
            },
            {
    ...
    },
    {
      ...
      "formulas": [
        ...
        },
        {
          ...
          "nombre": "الوتيرة المطلوبة لهدف الماراثون",
          "expresion": "metaMin / 42.195",
          "resultado": "paso",
          "variables": [
            {
              "simbolo": "metaMin",
              "nombre": "الهدف بالدقائق",
              "unidad": "min",
              "valor": 240
            }
          ],
        ...
        {
          "id": "demo-vo2",
          "nombre": "VO₂ الأقصى التقريبي",
          "expresion": "15.3 * fcmax / fcrep",
          "resultado": "VO2",
          "tex": "VO_{2}\\,max \\approx 15.3\\,\\dfrac{HR_{max}}{HR_{rest}}",
          "descripcion": "معادلة أوث: تقريبية، لكنها كافية لمعرفة ما إذا كنت أتحسن.",
          "variables": [
            {
              "simbolo": "fcmax",
              "nombre": "أقصى معدل لضربات القلب",
              "unidad": "نبضة/د",
              "valor": 189
            },
            {
              "simbolo": "fcrep",
              "nombre": "معدل ضربات القلب في الراحة",
              "unidad": "نبضة/د",
              "valor": 52
            }
          ],
  ...
  "hojas": [
    ...
    },
    {
      ...
      "celdas": {
        ...
        "A10": {
          "crudo": "ما أحتاجه في الاختبار النهائي"
        },
        "D10": {
