/**
 * Rama «ru» del año demo de computo. Solo se descarga si el usuario
 * está en ese idioma (el índice `demo.data.i18n.ts` la carga con import()).
 *
 * Las frases se traducen en `traducciones/computo.ru.json`; este
  ...
  "carpetas": [
      ...
      "formulas": [
        {
          ...
          "nombre": "Положение при постоянном ускорении",
          ...
          "variables": [
            {
              "simbolo": "x0",
              "nombre": "начальное положение",
              "unidad": "m",
              "valor": 0
            },
            {
              "simbolo": "v0",
              "nombre": "начальная скорость",
              "unidad": "m/s",
              "valor": 0
            },
            {
        ...
        },
        {
          ...
          "nombre": "Торричелли (скорость без времени)",
        ...
        },
        {
          ...
          "nombre": "Кинетическая энергия",
          "expresion": "m * v^2 / 2",
          "resultado": "Ek",
          "tex": "E_{k} = \\tfrac{1}{2}m\\,v^{2}",
          "descripcion": "При фиксированной массе: почти всегда считаю её для себя во время бега.",
          "variables": [
            {
              "simbolo": "m",
              "nombre": "масса",
        ...
        },
        {
          ...
          "nombre": "Период математического маятника",
          ...
          "variables": [
            ...
            {
              "simbolo": "g",
              "nombre": "ускорение свободного падения",
              "unidad": "m/s²",
              "valor": 9.81,
              "constante": true
            }
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-costo-taza",
          "nombre": "Себестоимость чашки",
          "expresion": "precioKg / 1000 * gramos + leche + vaso",
          "resultado": "costo",
          "descripcion": "Во сколько обходится подать одну чашку, не считая времени.",
          "variables": [
            {
              "simbolo": "precioKg",
              "nombre": "цена килограмма кофе",
              "unidad": "$",
              "valor": 420
            },
            {
              "simbolo": "gramos",
              "nombre": "граммов на чашку",
              "unidad": "g",
              "valor": 18
            },
            {
              "simbolo": "leche",
              "nombre": "стоимость молока",
              "unidad": "$",
              "valor": 4.5
            },
            {
              "simbolo": "vaso",
              "nombre": "стакан и крышка",
              "unidad": "$",
              "valor": 2.8
            }
          ],
        ...
        {
          "id": "demo-margen",
          "nombre": "Маржа от цены",
          "expresion": "(pv - costo) / pv * 100",
          "resultado": "margen",
          "tex": "маржа = \\dfrac{цена - себестоимость}{цена} \\times 100",
          "variables": [
            {
              "simbolo": "pv",
              "nombre": "цена продажи",
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-ritmo",
          "nombre": "Темп на километр",
          "expresion": "minutos / km",
          "resultado": "ritmo",
          "tex": "темп = \\dfrac{минуты}{км}",
          "variables": [
            {
              "simbolo": "minutos",
              "nombre": "всего минут",
        ...
        },
        {
          ...
          "nombre": "Темп для цели марафона",
          "expresion": "metaMin / 42.195",
          "resultado": "paso",
          "variables": [
            {
              "simbolo": "metaMin",
              "nombre": "цель в минутах",
              "unidad": "min",
              "valor": 240
            }
          ],
        ...
        {
          "id": "demo-vo2",
          "nombre": "Приблизительный VO₂ макс",
          "expresion": "15.3 * fcmax / fcrep",
          "resultado": "VO2",
          "tex": "VO_{2}\\,макс \\approx 15.3\\,\\dfrac{ЧСС_{макс}}{ЧСС_{покоя}}",
          "descripcion": "Формула Ута: приблизительная, но её достаточно, чтобы понять, есть ли прогресс.",
          "variables": [
            {
              "simbolo": "fcmax",
              "nombre": "максимальный пульс",
              "unidad": "уд/мин",
              "valor": 189
            },
            {
              "simbolo": "fcrep",
              "nombre": "пульс в покое",
              "unidad": "уд/мин",
              "valor": 52
            }
          ],
  ...
  "hojas": [
    ...
    },
    {
      ...
      "celdas": {
        ...
        "A10": {
          "crudo": "Нужно на итоговом экзамене"
        },
        "D10": {
