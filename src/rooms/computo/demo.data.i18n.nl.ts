/**
 * Rama «nl» del año demo de computo. Solo se descarga si el usuario
 * está en ese idioma (el índice `demo.data.i18n.ts` la carga con import()).
 *
 * Las frases se traducen en `traducciones/computo.nl.json`; este
...
export default {
  "carpetas": [
    ...
    {
      "id": "demo-parciales",
      "nombre": "Tussentoetsen",
      "emoji": "📐",
      "padre": "demo-fisica",
      "formulas": [
        {
          "id": "cat-fisica-mrua-posicion",
          "nombre": "Positie bij constante versnelling",
        ...
        },
        {
          ...
          "nombre": "Torricelli (snelheid zonder tijd)",
        ...
        },
        {
          ...
          "descripcion": "Met mijn eigen massa vast: ik bereken de energie bijna altijd voor mezelf tijdens het hardlopen.",
          "variables": [
            {
              "simbolo": "m",
              "nombre": "massa",
        ...
        },
        {
          ...
          "nombre": "Periode van de enkelvoudige slinger",
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-costo-taza",
          "nombre": "Kosten per kopje",
          "expresion": "precioKg / 1000 * gramos + leche + vaso",
          "resultado": "costo",
          "descripcion": "Wat het kost om een kopje te serveren, zonder de tijd mee te rekenen.",
          "variables": [
            {
              "simbolo": "precioKg",
              "nombre": "prijs per kilo koffie",
              "unidad": "$",
              "valor": 420
            },
            {
              "simbolo": "gramos",
              "nombre": "gram per kopje",
              "unidad": "g",
              "valor": 18
            },
            {
              "simbolo": "leche",
              "nombre": "kosten van de melk",
              "unidad": "$",
              "valor": 4.5
            },
            {
              "simbolo": "vaso",
              "nombre": "beker en deksel",
              "unidad": "$",
              "valor": 2.8
            }
          ],
        ...
        {
          "id": "demo-margen",
          "nombre": "Marge op de prijs",
          "expresion": "(pv - costo) / pv * 100",
          "resultado": "margen",
          "tex": "marge = \\dfrac{prijs - kosten}{prijs} \\times 100",
          "variables": [
            {
              "simbolo": "pv",
              "nombre": "verkoopprijs",
    ...
    },
    {
      ...
      "formulas": [
        ...
        },
        {
          ...
          "nombre": "Tempo voor het marathondoel",
          "expresion": "metaMin / 42.195",
          "resultado": "paso",
          "variables": [
            {
              "simbolo": "metaMin",
              "nombre": "doel in minuten",
              "unidad": "min",
              "valor": 240
            }
          ],
        ...
        {
          "id": "demo-vo2",
          "nombre": "Geschatte VO₂ max",
          "expresion": "15.3 * fcmax / fcrep",
          "resultado": "VO2",
          "tex": "VO_{2}\\,max \\approx 15.3\\,\\dfrac{HS_{max}}{HS_{rust}}",
          "descripcion": "De formule van Uth: bij benadering, maar goed genoeg om te zien of ik vooruitga.",
          "variables": [
            {
              "simbolo": "fcmax",
              "nombre": "maximale hartslag",
              "unidad": "bpm",
              "valor": 189
            },
            {
              "simbolo": "fcrep",
              "nombre": "hartslag in rust",
              "unidad": "bpm",
              "valor": 52
            }
          ],
