/**
 * Rama «de» del año demo de computo. Solo se descarga si el usuario
 * está en ese idioma (el índice `demo.data.i18n.ts` la carga con import()).
 *
 * Las frases se traducen en `traducciones/computo.de.json`; este
  ...
  "carpetas": [
      ...
      "formulas": [
        {
          ...
          "nombre": "Ort bei konstanter Beschleunigung",
          ...
          "variables": [
            {
              "simbolo": "x0",
              "nombre": "Anfangsposition",
              "unidad": "m",
              "valor": 0
            },
            {
              "simbolo": "v0",
              "nombre": "Anfangsgeschwindigkeit",
              "unidad": "m/s",
              "valor": 0
            },
            {
              "simbolo": "a",
              "nombre": "Beschleunigung",
              "unidad": "m/s²",
              "valor": 9.81
            },
            {
        ...
        },
        {
          ...
          "nombre": "Torricelli (Geschwindigkeit ohne Zeit)",
        ...
        },
        {
          ...
          "nombre": "Kinetische Energie",
          "expresion": "m * v^2 / 2",
          "resultado": "Ek",
          "tex": "E_{k} = \\tfrac{1}{2}m\\,v^{2}",
          "descripcion": "Bei fester eigener Masse: Ich berechne sie fast immer für mich selbst beim Laufen.",
          "variables": [
            {
              "simbolo": "m",
              "nombre": "Masse",
        ...
        },
        {
          ...
          "nombre": "Periode des mathematischen Pendels",
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-costo-taza",
          "nombre": "Kosten pro Tasse",
          "expresion": "precioKg / 1000 * gramos + leche + vaso",
          "resultado": "costo",
          "descripcion": "Was es kostet, eine Tasse zu servieren, ohne meine Zeit mitzurechnen.",
          "variables": [
            {
              "simbolo": "precioKg",
              "nombre": "Preis pro Kilo Kaffee",
              "unidad": "$",
              "valor": 420
            },
            {
              "simbolo": "gramos",
              "nombre": "Gramm pro Tasse",
              "unidad": "g",
              "valor": 18
            },
            {
              "simbolo": "leche",
              "nombre": "Kosten für die Milch",
              "unidad": "$",
              "valor": 4.5
            },
            {
              "simbolo": "vaso",
              "nombre": "Becher und Deckel",
              "unidad": "$",
              "valor": 2.8
            }
          ],
        ...
        {
          "id": "demo-margen",
          "nombre": "Marge auf den Preis",
          "expresion": "(pv - costo) / pv * 100",
          "resultado": "margen",
          "tex": "Marge = \\dfrac{Preis - Kosten}{Preis} \\times 100",
          "variables": [
            {
              "simbolo": "pv",
              "nombre": "Verkaufspreis",
              "unidad": "$",
              "valor": 45
            },
            {
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-ritmo",
          "nombre": "Tempo pro Kilometer",
          "expresion": "minutos / km",
          "resultado": "ritmo",
          "tex": "Tempo = \\dfrac{Minuten}{km}",
          "variables": [
            {
              "simbolo": "minutos",
              "nombre": "Minuten insgesamt",
              "unidad": "min",
              "valor": 58
            },
            {
        ...
        },
        {
          ...
          "nombre": "Tempo für das Marathonziel",
          "expresion": "metaMin / 42.195",
          "resultado": "paso",
          "variables": [
            {
              "simbolo": "metaMin",
              "nombre": "Ziel in Minuten",
              "unidad": "min",
              "valor": 240
            }
          ],
        ...
        {
          "id": "demo-vo2",
          "nombre": "Ungefähres VO₂max",
          "expresion": "15.3 * fcmax / fcrep",
          "resultado": "VO2",
          "tex": "VO_{2}\\,max \\approx 15.3\\,\\dfrac{HF_{max}}{HF_{ruhe}}",
          "descripcion": "Die Uth-Formel: ungefähr, aber gut genug, um zu sehen, ob ich mich verbessere.",
          "variables": [
            {
              "simbolo": "fcmax",
              "nombre": "Maximale Herzfrequenz",
              "unidad": "Schläge/min",
              "valor": 189
            },
            {
              "simbolo": "fcrep",
              "nombre": "Herzfrequenz in Ruhe",
              "unidad": "Schläge/min",
              "valor": 52
            }
          ],
