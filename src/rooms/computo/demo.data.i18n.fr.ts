/**
 * Rama «fr» del año demo de computo. Solo se descarga si el usuario
 * está en ese idioma (el índice `demo.data.i18n.ts` la carga con import()).
 *
 * Las frases se traducen en `traducciones/computo.fr.json`; este
  ...
  "carpetas": [
      ...
      "formulas": [
        {
          ...
          "nombre": "Position à accélération constante",
          ...
          "variables": [
            {
              "simbolo": "x0",
              "nombre": "position initiale",
              "unidad": "m",
              "valor": 0
            },
            {
              "simbolo": "v0",
              "nombre": "vitesse initiale",
              "unidad": "m/s",
              "valor": 0
            },
            {
        ...
        },
        {
          ...
          "nombre": "Torricelli (vitesse sans temps)",
        ...
        },
        {
          ...
          "nombre": "Énergie cinétique",
          "expresion": "m * v^2 / 2",
          "resultado": "Ek",
          "tex": "E_{k} = \\tfrac{1}{2}m\\,v^{2}",
          "descripcion": "Avec ma masse fixée : je la calcule presque toujours pour moi en train de courir.",
          "variables": [
            {
              "simbolo": "m",
              "nombre": "masse",
        ...
        },
        {
          ...
          "nombre": "Période du pendule simple",
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-costo-taza",
          "nombre": "Coût par tasse",
          "expresion": "precioKg / 1000 * gramos + leche + vaso",
          "resultado": "costo",
          "descripcion": "Ce que coûte servir une tasse, sans compter le temps.",
          "variables": [
            {
              "simbolo": "precioKg",
              "nombre": "prix du kilo de café",
              "unidad": "$",
              "valor": 420
            },
            {
              "simbolo": "gramos",
              "nombre": "grammes par tasse",
              "unidad": "g",
              "valor": 18
            },
            {
        ...
        {
          "id": "demo-margen",
          "nombre": "Marge sur le prix",
          "expresion": "(pv - costo) / pv * 100",
          "resultado": "margen",
          "tex": "marge = \\dfrac{prix - coût}{prix} \\times 100",
          "variables": [
            {
              "simbolo": "pv",
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-ritmo",
          "nombre": "Allure au kilomètre",
          "expresion": "minutos / km",
          "resultado": "ritmo",
          "tex": "allure = \\dfrac{minutes}{km}",
          "variables": [
            {
              "simbolo": "minutos",
              "nombre": "minutes totales",
              "unidad": "min",
              "valor": 58
            },
            {
        ...
        },
        {
          ...
          "nombre": "Allure pour l’objectif marathon",
          "expresion": "metaMin / 42.195",
          "resultado": "paso",
          "variables": [
            {
              "simbolo": "metaMin",
              "nombre": "objectif en minutes",
              "unidad": "min",
              "valor": 240
            }
          ],
        ...
        {
          "id": "demo-vo2",
          "nombre": "VO₂ max approximatif",
          "expresion": "15.3 * fcmax / fcrep",
          "resultado": "VO2",
          "tex": "VO_{2}\\,max \\approx 15.3\\,\\dfrac{FC_{max}}{FC_{repos}}",
          "descripcion": "La formule d’Uth : approximative, mais utile pour voir si je progresse.",
          "variables": [
            {
              "simbolo": "fcmax",
              "nombre": "fréquence cardiaque maximale",
              "unidad": "bpm",
              "valor": 189
            },
            {
              "simbolo": "fcrep",
              "nombre": "fréquence cardiaque au repos",
              "unidad": "bpm",
              "valor": 52
            }
          ],
