/**
 * Rama «it» del año demo de computo. Solo se descarga si el usuario
 * está en ese idioma (el índice `demo.data.i18n.ts` la carga con import()).
 *
 * Las frases se traducen en `traducciones/computo.it.json`; este
  ...
  "carpetas": [
      ...
      "formulas": [
        {
          ...
          "nombre": "Posizione con accelerazione costante",
          ...
          "variables": [
            {
              "simbolo": "x0",
              "nombre": "posizione iniziale",
              "unidad": "m",
              "valor": 0
            },
            {
              "simbolo": "v0",
              "nombre": "velocità iniziale",
              "unidad": "m/s",
              "valor": 0
            },
            {
              "simbolo": "a",
              "nombre": "accelerazione",
              "unidad": "m/s²",
              "valor": 9.81
            },
            {
        ...
        },
        {
          ...
          "nombre": "Torricelli (velocità senza tempo)",
        ...
        },
        {
          ...
          "descripcion": "Con la mia massa fissa: la calcolo quasi sempre per me mentre corro.",
          "variables": [
            {
              "simbolo": "m",
              "nombre": "massa",
        ...
        },
        {
          ...
          "nombre": "Periodo del pendolo semplice",
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-costo-taza",
          "nombre": "Costo per tazza",
          "expresion": "precioKg / 1000 * gramos + leche + vaso",
          "resultado": "costo",
          "descripcion": "Quanto costa servire una tazza, senza contare il tempo.",
          "variables": [
            {
              "simbolo": "precioKg",
              "nombre": "prezzo al chilo del caffè",
              "unidad": "$",
              "valor": 420
            },
            {
              "simbolo": "gramos",
              "nombre": "grammi per tazza",
              "unidad": "g",
              "valor": 18
            },
            {
              "simbolo": "leche",
              "nombre": "costo del latte",
              "unidad": "$",
              "valor": 4.5
            },
            {
              "simbolo": "vaso",
              "nombre": "bicchiere e coperchio",
              "unidad": "$",
              "valor": 2.8
            }
          ],
        ...
        {
          "id": "demo-margen",
          "nombre": "Margine sul prezzo",
          "expresion": "(pv - costo) / pv * 100",
          "resultado": "margen",
          "tex": "margine = \\dfrac{pv - costo}{pv} \\times 100",
          "variables": [
            {
              "simbolo": "pv",
              "nombre": "prezzo di vendita",
              "unidad": "$",
              "valor": 45
            },
            {
              "simbolo": "costo",
              "nombre": "costo della tazza",
              "unidad": "$",
              "valor": 14.9
            }
          ],
    ...
    },
    {
      ...
      "formulas": [
        {
          "id": "demo-ritmo",
          "nombre": "Ritmo al chilometro",
          "expresion": "minutos / km",
          "resultado": "ritmo",
          "tex": "ritmo = \\dfrac{minuti}{km}",
          "variables": [
            {
              "simbolo": "minutos",
              "nombre": "minuti totali",
              "unidad": "min",
              "valor": 58
            },
            {
        ...
        },
        {
          ...
          "nombre": "Ritmo per l'obiettivo della maratona",
          "expresion": "metaMin / 42.195",
          "resultado": "paso",
          "variables": [
            {
              "simbolo": "metaMin",
              "nombre": "obiettivo in minuti",
              "unidad": "min",
              "valor": 240
            }
          ],
        ...
        {
          "id": "demo-vo2",
          "nombre": "VO₂ max approssimato",
          "expresion": "15.3 * fcmax / fcrep",
          "resultado": "VO2",
          "tex": "VO_{2}\\,max \\approx 15.3\\,\\dfrac{FC_{max}}{FC_{riposo}}",
          "descripcion": "La formula di Uth: approssimata, ma utile per vedere se sto migliorando.",
          "variables": [
            {
              "simbolo": "fcmax",
              "nombre": "frequenza massima",
              "unidad": "bpm",
              "valor": 189
            },
            {
              "simbolo": "fcrep",
              "nombre": "frequenza a riposo",
              "unidad": "bpm",
              "valor": 52
            }
          ],
