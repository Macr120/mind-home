...
export const KO_TUT: Dict = {
  ...
  'tut.app-computo--formulario.1.texto':
    '공식집 전체가 이 메뉴 안에 있어요. 계산하는 자리에서 한 번만 누르면 돼요. 수학, 물리, 화학이 미리 담겨 주제별 폴더로 묶여 있고, 폴더는 원하는 만큼 겹쳐 넣을 수 있어요. 지민은 중간고사가 딸린 물리 II, 카페 계산, 달리기 계산도 갖고 있어요.',
  ...
  'tut.app-computo--hojas.1.texto': '시트 하나하나가 독립된 문서예요. 지민은 일본 여행 예산, 마라톤 18주 계획, 물리 II 성적을 갖고 있어요.',
  ...
  'tut.casa.1.texto': '여기가 내 MindHaOS예요. 방마다 앱이 하나씩 들어 있어요. 기본 조작을 알려드릴게요.',
  'tut.casa.2.titulo': '메인 메뉴',
  'tut.casa.2.texto': '열어서 보여줄게요: 이게 메인 메뉴예요, 당신의 방과 그 앱들이 있죠. 다른 탭에는 실내(앱 카탈로그)와, 땅 위에 짓는 실외가 들어 있어요.',
  'tut.casa.2b.titulo': '앱 목록',
  'tut.casa.2b.texto': '두 번째 탭이에요. 템플릿 목록이죠. 이 MindHaOS에 들일 수 있는 모든 앱이 있고, 저마다 방에 배정될 준비가 돼 있어요.',
  'tut.casa.2c.titulo': '실외',
  'tut.casa.2c.texto': '세 번째는 실외예요 — 레이싱 트랙, 코트, 텃밭, 생추어리, 페인트볼. 방을 차지하지 않고 땅 위에 바로 짓는 것들이죠.',
  'tut.casa.3.titulo': '이동하기',
  'tut.casa.3.texto':
    '조이스틱, WASD, 방향키로 걸어요. MindHaOS 전체를 걸어서 돌아다닐 수 있어요. 그런데 걷는 것만으로는 앱이 열리지 않아요 — 들어가려면 방의 오브가 떠 있는 오브젝트를 누르세요.',
  ...
  'tut.casa.editor.texto': '위쪽 \'편집기\' 버튼이 여는 게 바로 여기예요. 지도, 캐릭터, 오브젝트, 설정, 네 탭으로 된 전체 꾸미기죠. MindHaOS 전체를 여기서 그리고 입혀요.',
  ...
  'tut.primeros.6.texto':
    '이게 전부예요. 방을 만들고, 앱을 주고, 들어가서, 자리를 잡아 주면 돼요. 이 방은 연습용이었어요 — 끝나면 제가 거둬 갈게요. MindHaOS는 당신 마음대로 꾸미시라고요.',
  'tut.menu-cuartos.1.texto': '홈 탭은 MindHaOS의 모든 방을 분류별로 묶어 보여줘요.',
  ...
  'tut.menu-plantillas.2.texto': '생산성은 일과 생활의 앱이고, 창작은 Studio예요: 오디오, 아트, 글쓰기, 영상. 모두 똑같이 방의 물건에 배정해서 써요.',
  'tut.menu-plantillas.3.titulo': '카탈로그',
  'tut.menu-plantillas.3.texto': '기본 앱과 당신이 만든 앱을 그룹별로 정리해 뒀어요. 하나를 누르면 방에 배정돼요.',
  ...
  'tut.menu-inventario.1.texto': '인벤토리예요. MindHaOS에 놓을 수 있는 오브젝트가 전부 모여 있고, 바로 끌어다 쓸 수 있어요.',
  'tut.menu-inventario.2.titulo': '지도',
  'tut.menu-inventario.2.texto': '이미 놓여 있는 것들을 방별로 보여줘요: 썸네일을 누르면 그 오브젝트를 편집해요.',
  'tut.menu-inventario.3.titulo': '카탈로그',
  'tut.menu-inventario.3.texto': '존재하는 모든 오브젝트를 두 폴더로: 평범한 것과 특별한 것 — 탈 수 있는 탈것, 분수, 놀이기구, 조명처럼 뭔가를 하는 것들이죠.',
  'tut.menu-inventario.4.titulo': '배치',
  'tut.menu-inventario.4.texto': '카탈로그를 연 채로 썸네일을 3D 장면에 바로 끌어다 놓으면 원하는 자리에 놓여요.',
  'tut.menu-inventario.5.texto': '다른 갈래인 「만들기」는 조각이나 AI로 새 오브젝트를 만들고, 지금 고른 것을 편집하는 곳이에요.',
  'tut.editor-mapa.1.texto': 'MindHaOS 에디터에는 탭이 4개 있어요: 지도, 캐릭터, 오브젝트, 설정. 이번 투어는 \'지도\' 편이고, 나머지 셋도 각자의 투어가 있어요.',
  ...
  'tut.editor-mapa.4.texto':
    'MindHaOS에는 층도 있어요. 위로 쌓는 층과 아래로 내려가는 지하실이요. 새 층은 올라가는 방법을 처음부터 하나 갖고 태어나요. 계단이거나 슬래브에 뚫린 구멍인데, 위층 바닥을 관통해요.',
  'tut.editor-mapa.5.titulo': '완료',
  'tut.editor-mapa.5.texto': '편집하는 동안 모든 게 알아서 저장돼요. \'완료\'를 누르면 에디터가 닫히고, 두고 온 그대로의 MindHaOS로 돌아가요.',
  ...
  'tut.respaldo.1.titulo': 'MindHaOS가 사는 곳',
  ...
  'tut.editor-cuarto.1.texto': '지금은 특정 방을 편집하고 있어요. 도면과 카메라가 MindHaOS 전체가 아니라 그 방에 초점을 맞춰요.',
  ...
  'tut.inicio.1.texto': 'MindHaOS 이름이 적힌 버튼을 누르면 시작 화면이 열려요. 당신의 앱들이 격자로 늘어서고, 휴대폰과 똑같이 움직여요.',
  ...
  'tut.chat.1.texto': '건축가 채팅이에요. 하루를 기록하고, MindHaOS를 편집하고, 궁금한 걸 물어보는 걸 전부 같은 입력창에서 해요.',
  ...
  'tut.chat.4b.texto': '카메라를 켜고 당신 얼굴에 마스크를 씌워서, 움직임을 실시간으로 따라와요. MindHaOS 소개 영상에 나오는 바로 그 마스크예요. AI도 계정도 없이 돼요.',
  ...
  'tut.chat-registros.porAsistente.texto': '어시스턴트마다 함께 기록한 내용과 당신에 대해 기억하는 것을 자기 채팅에 보관해요. 이 버튼을 누르면 그래프로 열려요. 각 기억은 앱에서 언급한 것과 저절로 연결돼요. 하나를 탭하면 고치거나 잊게 할 수 있어요.',
  'tut.chat-registros.mapa.texto': '어시스턴트와 대화하면 지도에 나타나고, 대화를 삭제하면 지도에서 사라져요. 다시 부르려면 채팅 목록 아래의 ‘어시스턴트 추가’를 사용하세요.',
  ...
  'tut.app-generica.4.texto': '\'MindHaOS로 돌아가기\'로 앱을 닫고 3D로 돌아가요. 여기서 기록한 건 이미 저장돼 있어요.',
  ...
  'tut.musica.1.texto': '이 버튼을 누르면 MindHaOS의 음악 조절이 열려요.',
  'tut.musica.2.titulo': '켜기 또는 끄기',
  'tut.musica.2.texto': 'MindHaOS의 배경 음악 전체를 켜고 끄는 스위치예요. 끄면 개별 동작 소리만 남고 MindHaOS는 조용해져요.',
  'tut.musica.3.titulo': '방마다 다른 테마곡',
  'tut.musica.3.texto': '방마다 다르게 들릴 수 있어요. 앱에 맞춘 자동, 직접 고른 곡, 아니면 그 방만 완전히 무음으로 두기(MindHaOS의 나머지는 그대로예요).',
  ...
  'tut.cuenta-ia.1.texto': '여기서 MindHaOS의 AI를 켜요. 켜지 않으면 채팅은 키워드로만 작동하고, 레시피나 계획, 이미지를 만드는 기능은 꺼진 채로 있어요.',
  ...
  'tut.hoy.8.texto':
    'MindHaOS를 한번 보세요. 각 방의 가구 위에 떠 있는 오브는 오늘 그곳에 할 일이 남아 있으면 빨갛게, 아무것도 남지 않았으면 초록으로 바뀌어요. 정확한 개수는 카드의 빨간 표시에 나와요 — 홈 화면, 메뉴, 들어가기 말풍선 — 시간이 지난 게 있으면 호박색이 되고요.',
  'tut.hoy.9.titulo': '그리고 캘린더에 전부 모여서',
  'tut.hoy.9.texto':
    '이게 시계의 미션 버튼이고, 여기에도 표시가 붙어요. MindHaOS 전체에서 오늘 할 일을 앱별 카드로 모아 주는데, 왼쪽은 남은 것, 오른쪽은 이미 끝낸 것이에요. 여기서는 기록하지 않아요. 각 줄을 누르면 해당 앱으로 가고, 데이터는 거기에 적혀요.',
  'tut.progreso.1.texto': '내 캐릭터 카드예요. 지민에게는 1년치 실제 활동이 쌓여 있어서, 여기 있는 숫자마다 진짜 이야기가 있어요.',
  ...
  'tut.progreso.3.texto': '등반 등급은 열두 단계예요. 활동한 날마다 365칸 중 한 칸씩 올라가요. 지민은 벌써 여러 등급을 얻었어요. 탭하면 산 전체를 볼 수 있어요.',
  ...
  'tut.infra-huerto--ciclo.8.texto': '여기가 지민의 보호소예요. 한쪽에는 우리가, 다른 쪽에는 그들을 먹여 살리는 텃밭이 있어요. 구획으로 가볼까요?',
  'tut.infra-huerto--ciclo.1.texto':
    '여기는 지민의 보호소 텃밭이에요. 한 해 동안 손길이 쌓인 진짜 구획들이죠. 예시가 아니라 살아 있고, 실시간으로 자라고, 직접 만질 수 있어요.',
  ...
  'tut.infra-huerto--ciclo.3.texto':
    '구획을 보세요. 막 심은 씨앗, 절반쯤 자란 작물, 수확할 수 있는 해바라기… 그리고 지민이 일부러 물을 주지 않은 당근이 있어요. 파란 물방울이 목마름을 알려줘요. 시든 작물은 되살릴 수 없어요.',
  ...
  'tut.infra-granja--cuidar.8.texto': '여기가 지민의 보호소예요. 구조된 동물들의 우리가 있고, 남쪽에는 그들이 먹는 텃밭이 있어요. 함께 내려가 볼까요.',
  'tut.infra-granja--cuidar.1.texto': '지민의 보호소에서 구조된 동물들이에요. 저마다 이름이 있고, 배고픔과 기분이 실시간으로 흘러가요. 예시가 아니라 진짜로 돌볼 수 있어요.',
  'tut.infra-granja--cuidar.2.titulo': '한 해의 곳간',
  'tut.infra-granja--cuidar.2.texto': '\'먹이 주기\'는 바구니에서 꺼내 쓰고, 바구니는 옆 텃밭을 수확하면 채워져요. 지민이 한 해치 비축을 남겼어요. 마음껏 쓰세요.',
  ...
  'tut.infra-caminos--carrera.1.texto':
    '여기는 지민의 경주 트랙이에요. 체커 무늬 결승선이 있는 아스팔트 타원 트랙이죠. 지도에서 유일한 결승선이라, 레이스 모드는 전부 이곳을 중심으로 돌아가요.',
  ...
  'tut.infra-caminos--carrera.4.texto': '결승선 옆에는 베스트 기록표가 있어요. 지민의 자전거는 38승에 베스트 랩 41.8초예요. 깨보세요. 데모에서 세운 기록도 저장돼요.',
  ...
  'tut.infra-caminos--trazos.3.texto':
    '내 MindHaOS에서는 \'서킷\' 편집기로 칸 하나씩 그리거나, \'자유 트랙\'으로 구역별로 자유롭게 그릴 수 있어요. 데모의 지도는 이미 그려져 있어요.',
  'tut.infra-canchas--jugar.1.texto':
    '여기는 지민의 스포츠 단지예요. 축구, 농구, 테니스, 야구가 나란히 있어요. 코트는 지도 위의 사각형이라, 걸어 들어가면 그 경기가 시작돼요.',
  ...
  'tut.app-jardin--practicar.1.texto': '연습한 1분 1분이 이 정원에 물을 줘요. 지민님의 정원은 1년 동안 씨앗에서 고요한 숲까지 자랐어요.',
  ...
  'tut.app-ideas--mapas.1.texto':
    '형식마다 그리는 방식이 달라요. 아래는 지민님이 한 해 동안 만든 맵이에요. 아침 루틴은 순서도로, 열역학은 트리로, 물리와 음악은 벤 다이어그램으로요.',
  'tut.app-ideas--mapas.2.titulo': '“내가 바라는 삶”',
  'tut.app-ideas--mapas.2.texto': '그해 첫 맵, 1개월째의 것이에요. 지민님이 원하던 삶이죠. 천천히 보세요. 여기 있는 것 거의 전부가 실제로 일어났어요.',
  ...
  'tut.app-ideas--decidir.1.texto': '지민님은 진짜로 써 봤어요. 중간고사 주간에는 아이젠하워 매트릭스, 연중에는 SWOT 분석, 카메라를 고를 때는 결정 매트릭스요.',
  ...
  'tut.calendario.1.texto': '캘린더는 방이 아니에요. MindHaOS 시계 안에 있어서 어디에 있든 열 수 있어요.',
  ...
  'tut.calendario.5.texto':
    '‹ › 화살표로 기간을 넘기고, \'오늘\'로 현재에 돌아와요. 지민의 한 해가 주 단위로 전부 여기 있어요. \'+ 새로 만들기\'로 이벤트를 만들거나 격자 위에 바로 그려도 돼요.',
  ...
  'tut.calendario.7.texto':
    '\'연도\' 보기에서는 그래프가 한 해의 이야기를 전부 들려줘요. 지민은 마음먹은 것의 3분의 1만 지키며 시작해서 85%를 넘기며 마쳤어요. 꾸준함은 나타난 게 아니라 쌓아 올린 거예요.',
  ...
  'tut.metas.0.texto':
    '이 방은 자기 것을 따로 두지 않아요. 목표는 다른 앱에서 태어나요. 달리기는 운동에서, 학위는 도서관에서, 저축은 금융에서요. 그리고 여기에서 전부 모여요. 어느 방에서 왔든 한눈에 함께 볼 수 있는 곳은 MindHaOS에서 여기뿐이에요.',
  'tut.metas.1.titulo': '목표마다 맡은 앱이 있어요',
  'tut.metas.1.texto':
    '폴더는 장식이 아니에요. 하나하나가 그 목표를 맡은 앱이고, 달성 여부를 아는 것도 그 앱이에요. 기록이 거기서 일어나니까요. 「집」은 앱이 아니에요 — 부엌 공사를 위해 지민이 직접 만든 분류예요.',
  'tut.metas.2.titulo': '같은 시트를, 양쪽에서',
  'tut.metas.2.texto':
    '목표를 누르면 시트가 열리고, 계획이 있으면 계획도 열려요. 그 앱에서 눌렀을 때 나오는 것과 같은 플래너인데, 차이가 하나 있어요. 거기서는 그 앱으로 좁혀지고, 여기서는 MindHaOS 전체의 목표까지 통째로 보여요.',
  ...
  'tut.app-biblioteca--enciclopedia.1.texto':
    '지민은 물리를 공부해요. 연초에는 역학, 6개월째 중간고사 무렵에는 열역학, 마지막에는 상대성이론과 천체물리. 가지를 펼치면 그 안의 항목이 보여요.',
  ...
  'tut.app-biblioteca--charlas.1.texto':
    '지민이 공부하면서 나눈 대화들이 여기 있어요. 엔트로피, 시간 지연, 피아노가 왜 피아노 소리로 들리는지. 하나하나 그대로 저장돼 있어요.',
  ...
  'tut.app-biblioteca--resumen.3.texto': '가장 긴 막대가 관심을 가장 많이 가져간 분야예요. 지민에게는 중간고사 주간의 열역학이었어요.',
  ...
  'tut.app-idiomas--repaso.1.texto': '지민은 벌써 1년째인데도 밀린 복습이 있어요. 모든 어휘를 다 물어보는 게 아니라, 잊어버리기 직전의 것만 나와요.',
  'tut.app-idiomas--repaso.3.titulo': '한 해의 꾸준함',
  'tut.app-idiomas--repaso.3.texto':
    '기록에는 하루에 몇 개를 복습했고 몇 개를 맞혔는지가 남아요. 지민은 꽤 많이 틀리며 시작해서 거의 다 맞히며 마쳤어요. 그리고 일본에서 그 어느 때보다 많이 복습했어요.',
  'tut.app-idiomas--vocabulario.2.titulo': '두 언어를 함께',
  'tut.app-idiomas--vocabulario.2.texto':
    '위에서 언어를 바꿀 수 있어요. 주 언어 말고도, 지민은 4개월째부터 여행까지 생존 일본어를 만들어 뒀어요. 돌아온 뒤로는 거의 손을 놓았고, 복습 상자에 그게 보여요.',
  ...
  'tut.calendario--esencial.1.titulo': 'MindHaOS의 시계',
  ...
  'tut.app-descanso--esencial.3.texto':
    '하루 띠의 양 끝을 끌어서 잠드는 시각과 일어나는 시각을 정해요. 같은 시간표는 MindHaOS 캘린더에도 블록으로 나타나요. 알람과 알람음, 그리고 자기 전에 속도를 늦추라는 알림도 여기서 켜요.',
  ...
  'tut.app-entretenimiento--esencial.1.texto':
    '다 본 영화와 드라마, 읽은 책, 즐긴 게임을 남길 수 있고, MindHaOS를 나서지 않고 즐기는 디지털 게임 테이블도 있어요. 메뉴는 보드게임과 아카이브, 두 가지예요.',
  ...
  'tut.app-garage--esencial.1.texto':
    '차고는 나의 이동 수단을 챙겨요. 자전거, 자동차, 오토바이 등 타고 다니는 것이면 무엇이든요. 한 대마다 정비 이력과 서류가 남고, 날짜가 있는 것은 모두 MindHaOS 캘린더에 알아서 들어가요.',
  ...
  'tut.app-metas--esencial.1.titulo': 'MindHaOS 전체의 계획을 세우는 곳',
  ...
  'tut.app-agenda--salud.1.texto': '몇 달에 한 번씩 가는 영양 상담, 치과, 그리고 7개월째의 물리치료 여섯 번. 지민을 멈춰 세운 부상이 여기에 기록돼 있어요.',
  ...
  'tut.app-agenda--salud.projimos.texto':
    '당신이 돌보는 사람들이에요. \'연락처\'에서 \'내가 돌봄\' 표시를 한 사람들이, 각자 진료과별 예약과 돌봄, 약과 함께 여기에 나와요. 지민은 여기서 어머니를 챙기고 있어요.',
  'tut.app-agenda--personas.1.titulo': '지민의 사람들',
  ...
  'tut.app-ejercicio--anio.1.texto':
    '연속 기록은 무언가를 기록한 날이 며칠 이어졌는지 세요. 달성률은 활동한 날을 스스로 정한 날과 비교해요. 지민은 연초에 두 블록도 뛰지 못했어요.',
  ...
  'tut.app-ejercicio--anio.3.texto':
    '“목표” 방에는 완료한 네 가지 목표—5K, 10K, 하프 마라톤, 풀 마라톤—와 아직 진행 중인 목표가 담겨 있어요. 날짜가 있는 목표는 MindHaOS 캘린더에도 나타나요.',
  'tut.app-ejercicio--carrera.1.titulo': '카탈로그, 루틴, 진행 상황',
  'tut.app-ejercicio--carrera.1.texto': '어떤 운동이든 구성은 같아요: 운동 카탈로그, 기록이 함께 있는 루틴, 그리고 진행 상황. 먼저 지민이 달려 온 것부터 볼게요.',
  ...
  'tut.app-ejercicio--fuerza.2.texto':
    '운동을 하나 고르면 어떻게 올라갔는지 보여요. 지민의 스쿼트는 40킬로에서 70킬로가 됐어요. 다친 달에는 상체만 훈련했는데, 그 곡선은 눈치도 못 챘어요.',
  ...
  'tut.app-cocina--alimentacion.1.texto':
    '체중, 키, 활동량으로 앱이 하루에 필요한 양을 계산하고 매크로를 나눠 줘요. 지민은 2,400칼로리와 1킬로도 남지 않은 목표 체중을 정했어요.',
  'tut.app-cocina--alimentacion.2.titulo': '2단계: 오늘 먹은 것',
  'tut.app-cocina--alimentacion.2.texto':
    '아침 식사, 점심 식사, 저녁 식사, 그리고 간식. 기록할 때마다 그날의 링이 채워져요. 수분은 목표가 따로 있고, MindHaOS가 하루를 완료로 볼 때 보는 게 바로 이거예요.',
  ...
  'tut.app-cocina--recetario.1.texto':
    '여기서 식단은 레시피가 담긴 계획이에요. 지민은 직접 두 개를 저장했어요. 마라톤 주간과, 일본에서 돌아온 뒤의 가벼운 식단. 앱에 처음부터 들어 있는 것들도 있어요.',
  ...
  'tut.app-descanso--noche.3.texto': '기록은 연·월·주로 남아요. 지민의 첫 몇 달까지 내려가서 마지막 달들과 비교해 보세요. 새벽 1시가 넘어 누웠고 다섯 시간밖에 못 잤어요.',
  ...
  'tut.app-despacho--anio.3.texto': '지금 보고 있는 기간을 카테고리별로 나눠서 보여줘요. 지민은 카테고리를 직접 적어요. 흔한 것은 앱이 알아보고, 나머지는 각자 색을 받아요.',
  ...
  'tut.app-despacho--captura.1.titulo': '지민의 고정 지출',
  ...
  'tut.app-despacho--metas.4.texto':
    '지민은 여행을 정한 뒤로 엔화를 지켜봤고, 지금은 다음 여행을 위해 원화를 봐요. 외환, 암호화폐, 주식, 원자재를 실시간으로 보여줘요(인터넷이 필요해요).',
  ...
  'tut.app-garage--vehiculos.2.texto': '차량이 몇 대인지, 진행 중인 서류가 몇 건인지, 올해 얼마를 썼는지 보여줘요. 지민은 그 차에 돈이 꽤 많이 들었어요.',
  ...
  'tut.app-garage--tramites.4.texto':
    '이 서류들은 MindHaOS 캘린더에도 미리 알림과 함께 들어가요. 그리고 참고로, 지도에서 몰고 다니는 탈것은 다른 거예요. 그건 \'인벤토리\'에 있어요.',
  ...
  'tut.app-sala--japon.1.texto': '나라마다 폴더 하나, 표지 사진과 함께 있어요. 안에는 장소마다 카드가 하나씩, 그 안에는 지민이 그날 쓴 글이 있어요.',
  ...
  'tut.app-entretenimiento--archivo.2.texto':
    '제목, 작가나 감독, 장르, 상태, 별점. 리뷰는 지민이 느낀 점이지 줄거리 요약이 아니에요. 1년 뒤에 도움이 되는 건 그것뿐이거든요.',
  ...
  'tut.app-diario--habito.4.texto': '지민은 올해 200일쯤 읽었어요. 처음엔 많이, 힘들었던 달엔 거의 안 읽고, 마지막 3주는 매일이었어요. 연속 기록은 거기서 나온 거예요.',
