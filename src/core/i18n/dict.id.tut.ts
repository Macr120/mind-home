...
export const ID_TUT: Dict = {
  ...
  'tut.app-computo--formulario.1.texto':
    'Seluruh Buku Rumus tinggal di menu ini, satu ketukan dari tempat kamu berhitung. Matematika, Fisika, dan Kimia sudah terisi dan dikelompokkan per topik, dalam folder yang bisa kamu susun bertingkat sesukamu. Ari juga punya Fisika II beserta ujian tengah semesternya, hitungan kafe, dan hitungan lari.',
  ...
  'tut.app-computo--hojas.1.texto':
    'Setiap spreadsheet adalah dokumen tersendiri. Ari punya anggaran Jepang, rencana 18 minggu maraton, dan nilai Fisika II.',
  ...
  'tut.casa.7.texto':
    'Waktu di MindHaOS: sentuh dan kalender lengkap terbuka, dengan Misi hariannya. Dan matahari atau bulan membuka panel ini: laju waktu dan cahaya pemandangannya.',
  'tut.casa.8.titulo': 'Musik MindHaOS',
  'tut.casa.8.texto':
    'MindHaOS dimulai dalam sunyi: kalau mau musik latar, nyalakan musiknya di sini. Setiap ruangan membawa lagu-lagu tematik yang sudah dimuat, atau biarkan suasana umum MindHaOS yang berbunyi.',
  ...
  'tut.editor-mapa.4.texto':
    'MindHaOS-mu juga punya level: lantai yang bisa ditumpuk ke atas dan satu basemen ke bawah. Setiap level baru lahir dengan jalan naiknya sendiri —sebuah tangga atau lubang di pelat lantai— yang menembus lantai di atasnya.',
  'tut.editor-mapa.5.titulo': 'Selesai',
  'tut.editor-mapa.5.texto':
    'Semuanya tersimpan sendiri selagi kamu mengedit. Selesai menutup editor dan mengembalikanmu ke permainan dengan MindHaOS persis seperti yang kamu tinggalkan.',
  ...
  'tut.editor-config.4.texto':
    'Bahasa, tema antarmuka (terang/gelap/otomatis), gaya ikon, dan kerapatan — semua yang mengubah BAGAIMANA MindHaOS-mu terlihat, bukan apa isinya.',
  ...
  'tut.respaldo.1.titulo': 'Di mana MindHaOS-mu tinggal',
  ...
  'tut.editor-cuarto.1.texto':
    'Kamu sedang mengedit satu ruangan tertentu: denah dan kameranya fokus ke situ, bukan ke seluruh MindHaOS.',
  ...
  'tut.inicio.1.texto':
    'Tombol dengan nama MindHaOS-mu membuka layar beranda: aplikasi-aplikasimu dalam kisi, dengan mekanika sebuah ponsel.',
  ...
  'tut.chat.1.texto':
    'Chat Sang Arsitek: mencatat harimu, mengedit MindHaOS dan menjawab pertanyaanmu, semuanya dari kotak yang sama.',
  ...
  'tut.chat.4b.texto':
    'Ia menyalakan kamera dan memasangkan maskernya di wajahmu, mengikutimu secara langsung — masker yang sama dengan di video perkenalan MindHaOS. Bekerja tanpa AI dan tanpa akun.',
  ...
  'tut.app-generica.4.texto':
    '“Kembali ke MindHaOS” menutup aplikasinya dan mengembalikanmu ke 3D. Apa pun yang kamu catat di sini sudah tersimpan.',
  ...
  'tut.musica.1.texto': 'Tombol ini membuka kontrol musik MindHaOS.',
  'tut.musica.2.titulo': 'Nyalakan atau matikan',
  'tut.musica.2.texto':
    'Satu sakelar untuk seluruh musik ambien di MindHaOS. Saat mati, MindHaOS jadi sunyi kecuali suara dari aksi-aksi tertentu.',
  'tut.musica.3.titulo': 'Tema per ruangan',
  'tut.musica.3.texto':
    'Setiap ruangan bisa terdengar berbeda: otomatis mengikuti aplikasinya, satu tema yang kamu pilih sendiri, atau sunyi total di ruangan itu tanpa mengubah sisa MindHaOS.',
  ...
  'tut.cuenta-ia.1.texto':
    'Di sinilah AI MindHaOS dinyalakan: tanpa ini, obrolan tetap jalan lewat kata kunci, dan fitur seperti membuat resep, rencana, atau gambar tetap mati.',
  ...
  'tut.hoy.8.texto':
    'Lihat MindHaOS-mu: bola yang melayang di atas perabot tiap ruangan berubah merah kalau di sana masih ada yang harus dikerjakan hari ini, dan hijau kalau tidak ada lagi. Jumlah persisnya ada di gelembung merah kartunya — layar awal, menu, dan gelembung masuk — dan berubah kuning kecokelatan kalau ada yang sudah lewat jamnya.',
  'tut.hoy.9.titulo': 'Dan semuanya sekaligus, di kalender',
  'tut.hoy.9.texto':
    'Ini tombol Misi di jam, dengan gelembungnya sendiri: mengumpulkan apa saja yang harus dikerjakan hari ini di SELURUH MindHaOS, satu kartu per aplikasi — di kiri yang belum, di kanan yang sudah. Di sini tidak ada pencatatan: tiap baris membawamu ke aplikasinya, dan di sanalah datanya ditulis.',
  'tut.progreso.1.texto':
    'Kartu karaktermu: Ari punya satu tahun penuh aktivitas nyata di belakangnya, jadi setiap angka di sini punya cerita nyata yang menjelaskannya.',
  ...
  'tut.progreso.3.texto':
    'Dua belas pangkat pendakian: setiap hari dengan aktivitas menaikkanmu satu anak tangga dari 365. Ari sudah mengumpulkan beberapa pangkat; sentuh untuk melihat gunungnya secara utuh.',
  ...
  'tut.progreso.6.texto':
    'Wrapped menyusun rangkuman minggu, bulan, atau tahunmu dalam bentuk slide — ia punya tutorialnya sendiri, dengan data berlimpah pada tahun seperti milik Ari.',
  'tut.progreso.7.titulo': 'Radar per ruangan',
  'tut.progreso.7.texto':
    'Setiap sudutnya adalah satu ruangan di MindHaOS, dan ukurannya adalah jumlah XP dari aplikasi yang ditugaskan ke sana. Ruangan yang kosong dari aktivitas langsung kelihatan: sudutnya melesak ke tengah.',
  'tut.wrapped.1.texto':
  ...
  'tut.wrapped.2.texto':
    'Setiap jenis menyusun slide-nya sendiri dengan datanya sendiri — rangkuman tahunan Ari yang paling panjang, lengkap dengan momen tertinggi dan terendah sepanjang tahun.',
  ...
  'tut.infra-huerto--ciclo.8.texto':
    'Ini tempat perlindungan Ari: di satu sisi kandang-kandangnya dan di sisi lain kebun sayur yang memberi mereka makan. Ayo ke petak-petaknya.',
  'tut.infra-huerto--ciclo.1.texto':
    'Ini kebun sayur di suaka milik Ari: petak-petak nyata dengan kerja setahun di atasnya. Tidak ada satu pun yang cuma contoh — semuanya hidup, tumbuh secara real-time, dan bisa kamu sentuh.',
  ...
  'tut.infra-huerto--ciclo.3.texto':
    'Lihat petak-petaknya: ada benih yang baru ditanam, tanaman setengah tumbuh, bunga matahari yang siap… dan wortel layu yang sengaja dibiarkan Ari tanpa air. Tetes biru menandakan haus; yang sudah layu tidak bisa diselamatkan lagi.',
  ...
  'tut.infra-granja--cuidar.8.texto':
    'Ini suaka milik Ari: kandang para hewan yang diselamatkan dan, di sebelah selatan, kebun sayur tempat mereka makan. Ayo turun menemui mereka.',
  'tut.infra-granja--cuidar.1.texto':
    'Ini para hewan yang diselamatkan di suaka Ari: masing-masing punya nama, rasa lapar, dan suasana hati yang berjalan secara real-time. Tidak ada yang cuma contoh — kamu benar-benar bisa merawat mereka.',
  'tut.infra-granja--cuidar.2.titulo': 'Lumbung setahun',
  'tut.infra-granja--cuidar.2.texto':
    '“Beri makan” mengambil dari keranjang, dan keranjang terisi dengan memanen kebun sayur di sebelah. Ari meninggalkan stok setahun: pakai saja.',
  ...
  'tut.infra-caminos--carrera.1.texto':
    'Ini lintasan milik Ari: oval aspal dengan garis finis kotak-kotak. Ini satu-satunya garis finis di peta — seluruh mode balapan berputar di sekitarnya.',
  ...
  'tut.infra-caminos--carrera.4.texto':
    'Di samping garis finis ada tabel waktu terbaik: sepeda Ari mengumpulkan 38 kemenangan dan putaran terbaik 41,8 detik. Kalahkan — rekor yang kamu buat di demo ikut tersimpan.',
  ...
  'tut.infra-caminos--trazos.3.texto':
    'Di MindHaOS-mu sendiri kamu menggambarnya sel demi sel dengan editor Sirkuit, atau bebas dengan trek bebas per sektor. Di demo ini petanya sudah tergambar.',
  'tut.infra-canchas--jugar.1.texto':
    'Ini kompleks olahraga milik Ari: sepak bola, basket, tenis, dan bisbol, berjajar. Tiap lapangan adalah persegi panjang di peta — masuk ke dalamnya sambil berjalan langsung memulai permainannya.',
  ...
  'tut.infra-canchas--jugar.4.texto':
    'Papan skor disimpan per lapangan: Ari meninggalkan 21-15 di basket dan runtunan 18 reli di tenis. Di demo pertandingan ikut dihitung — lampaui saja.',
  ...
  'tut.infra-paintball--batalla.3.texto':
    'Seluruh MindHaOS adalah arenanya: berlindung di balik tembok, muncul sebentar untuk menembak, dan jaga punggungmu. Cipratan catnya tetap menempel selama pertempuran.',
  'tut.infra-paintball--batalla.4.texto':
    'Papan skor Ari berdiri di 47 kemenangan lawan 23 kekalahan. Di demo pertempuran benar-benar dihitung: naikkan skornya sebelum kamu pergi.',
  'tut.app-anecdotario--diario.1.texto':
    'Ini buku kenangan Ari: satu tahun penuh, dua tiga entri seminggu. SELURUH alurnya diceritakan di sini: dari rasa jenuh di awal sampai maraton dua minggu lalu.',
  ...
  'tut.app-anecdotario--fotos.1.texto':
    'Tonggak-tonggak tahun Ari punya foto: keyboard bekas itu, kedatangan Laika, dua kartu pos dari Jepang, dan medali maraton.',
  ...
  'tut.app-anecdotario--fotos.3.texto':
    'Setiap entri memberi makan runtunanmu dan membangunkan karaktermu: menulis di sini juga merawat MindHaOS.',
  'tut.app-jardin--practicar.1.titulo': 'Ketenangan terkumpul',
  'tut.app-jardin--practicar.1.texto':
    'Setiap menit latihan menyirami kebun ini. Kebun milik Ari tumbuh setahun penuh: dari benih jadi hutan.',
  ...
  'tut.app-jardin--practicar.3.texto':
    'Ini setahun milik Ari: mulai dari tiga kali seminggu, lalu di bulan ke-7 —cedera itu, biaya mobil— latihannya jadi hampir tiap hari. Itulah yang menahannya saat masa turun.',
  ...
  'tut.app-jardin--gratitud.2.titulo': 'Punya Ari',
  ...
  'tut.app-hobbies--piano.1.texto':
    'Ari mencatat dua: piano (proyek tahun itu, target 4 hari seminggu) dan astrofotografi. Tiap kartu menampilkan minggu berjalan dan runtunannya.',
  ...
  'tut.app-ideas--diario.1.texto':
    'Tulis apa yang terlintas, selesai. Ari melepas ~90 ide di sini sepanjang tahun: soal fisika, soal kafe, soal latihan. Bintangnya menandai yang paling kamu suka.',
  'tut.app-ideas--diario.2.titulo': 'Brainstorming per tema',
  'tut.app-ideas--diario.2.texto':
    'Brainstorming mengumpulkan semuanya di bawah satu tema. Cari punya Ari: nama-nama untuk kucingnya (Laika yang menang), cara membiayai Jepang, dan apa yang dibawa ke perjalanan.',
  ...
  'tut.app-ideas--mapas.1.texto':
    'Setiap format menggambar dengan caranya sendiri. Di bawah ada peta-peta yang Ari buat sepanjang tahun: rutinitas paginya sebagai diagram alur, termodinamika sebagai pohon, fisika dan musik sebagai diagram Venn.',
  'tut.app-ideas--mapas.2.titulo': '“Hidup idealku”',
  'tut.app-ideas--mapas.2.texto':
    'Peta PERTAMA tahun itu, dari bulan ke-1: hidup yang Ari inginkan. Lihat pelan-pelan — hampir semua yang ada di sini akhirnya benar-benar terjadi.',
  ...
  'tut.app-ideas--decidir.1.texto':
    'Ari benar-benar memakainya: satu Eisenhower di minggu ujian tengah semester, satu SWOT di pertengahan tahun, dan satu matriks untuk memilih kamera.',
  ...
  'tut.calendario.1.texto':
    'Kalender bukan sebuah ruangan: ia tinggal di jam MindHaOS, jadi bisa dibuka dari mana pun kamu berada.',
  ...
  'tut.calendario.5.texto':
    'Panah ‹ › menggeser periodenya dan Hari ini mengembalikanmu ke sekarang. Sepanjang tahun Ari ada di sini, minggu demi minggu. Dengan + Baru kamu membuat acara, atau kamu menggambarnya langsung di atas kisi.',
  ...
  'tut.calendario.7.texto':
    'Di tampilan Tahun grafiknya menceritakan kisah lengkapnya: Ari memulai dengan memenuhi sepertiga dari yang dia niatkan dan menutup tahun di atas 85%. Konsistensi itu dibangun, bukan datang sendiri.',
  ...
  'tut.metas.1.texto':
    'Foldernya bukan hiasan: tiap folder adalah aplikasi yang memegang target-target itu, dan aplikasi itulah yang tahu apakah tercapai, karena di sanalah kamu mencatat. «Rumah» bukan aplikasi — kategori itu dibuat sendiri oleh Ari untuk renovasi dapur.',
  'tut.metas.2.titulo': 'Lembar yang sama, dari dua sisi',
  'tut.metas.2.texto':
    'Menyentuh sebuah target membuka lembarnya dan, kalau ada, rencananya. Ini perencana yang SAMA dengan yang muncul saat kamu menyentuhnya dari aplikasinya, dengan satu beda: di sana terbatas pada aplikasi itu, di sini kamu melihatnya utuh, dengan target seluruh MindHaOS sekaligus.',
  ...
  'tut.app-biblioteca--enciclopedia.1.texto':
    'Ari kuliah Fisika: mekanika di awal tahun, termodinamika menjelang ujian tengah semester di bulan ke-6, relativitas dan astrofisika di akhir. Setiap cabang terbuka untuk memperlihatkan entri-entrinya.',
  ...
  'tut.app-biblioteca--charlas.1.texto':
    'Inilah percakapan yang dilakukan Ari sambil belajar: entropi, dilatasi waktu, kenapa piano terdengar seperti piano. Semuanya tersimpan.',
  ...
  'tut.app-biblioteca--resumen.3.texto':
    'Batang terpanjang adalah bidang yang paling menyita perhatianmu — bagi Ari, termodinamika di minggu ujian tengah semester.',
  ...
  'tut.app-idiomas--repaso.1.texto':
    'Ari sudah setahun menjalani ini dan masih punya tinjauan yang menunggu: sistemnya tidak meminta seluruh kosakatamu, hanya yang hampir kamu lupakan.',
  'tut.app-idiomas--repaso.3.titulo': 'Setahun konsisten',
  'tut.app-idiomas--repaso.3.texto':
    'Riwayatnya menyimpan berapa kartu yang kamu tinjau tiap hari dan berapa yang kamu jawab benar. Ari memulai dengan cukup banyak salah dan menutupnya dengan hampir semuanya benar — dan di Jepang dia meninjau lebih banyak dari kapan pun.',
  'tut.app-idiomas--vocabulario.2.titulo': 'Dua bahasa sekaligus',
  'tut.app-idiomas--vocabulario.2.texto':
    'Bahasanya diganti dari atas: selain bahasa utamanya, Ari menyusun bahasa Jepang bertahan hidup antara bulan ke-4 dan perjalanannya. Sepulang dari sana dia hampir meninggalkannya, dan itu terlihat di kotak-kotaknya.',
  ...
  'tut.app-idiomas--temario.2.texto':
    'Kartu yang dikuasai, tinjauan bulan ini, dan levelmu sekarang. Ari memulai tahun di A2 dan sekarang ada di sekitar B1.',
  'tut.app-agenda--esencial.1.titulo': 'Agendamu',
  'tut.app-agenda--esencial.1.texto':
    'Agenda menyimpan yang bukan kebiasaan: tugas, janji temu, kontak. Ada tiga menu, dan semua yang punya tanggal langsung masuk sendiri ke kalender MindHaOS.',
  ...
  'tut.calendario--esencial.1.titulo': 'Jam MindHaOS',
  ...
  'tut.app-descanso--esencial.3.texto':
    'Kamu atur jam tidur dan bangun dengan menyeret ujung-ujung garis harian; jadwal yang sama juga muncul sebagai blok di kalender MindHaOS. Di sini juga kamu nyalakan alarm dengan nadanya dan pengingat untuk memperlambat sebelum tidur.',
  ...
  'tut.app-entretenimiento--esencial.1.texto':
    'Menyimpan film, serial, buku, dan video game yang sedang kamu selesaikan, dan menghadirkan meja permainan digital untuk kamu mainkan tanpa keluar dari MindHaOS. Ada dua menu: Permainan Papan dan Arsip.',
  ...
  'tut.app-garage--esencial.1.texto':
    'Garasi melacak kendaraanmu: sepeda, mobil, motor, dan apa pun yang kamu pakai untuk berpindah tempat. Masing-masing punya riwayat servis dan administrasinya sendiri, dan semua yang punya tanggal langsung masuk sendiri ke kalender MindHaOS.',
  ...
  'tut.app-metas--esencial.1.titulo': 'Perencana MindHaOS',
  ...
  'tut.app-agenda--salud.1.texto':
    'Nutrisi tiap beberapa bulan, dokter gigi, dan enam sesi fisioterapi di bulan ke-7: cedera yang menghentikan Ari tercatat di sini.',
  ...
  'tut.app-agenda--salud.projimos.texto':
    'Mereka yang ada dalam perawatanmu: kontak dari Orang yang ditandai «Dalam perawatanku», masing-masing dengan janji temu per spesialisasi, perawatannya, dan obatnya. Ari menaruh ibunya di sini.',
  'tut.app-agenda--personas.1.titulo': 'Lingkaran Ari',
  ...
  'tut.app-ejercicio--anio.1.texto':
    'Runtunan aktif menghitung hari berturut-turut yang ada catatannya, dan Kepatuhan membandingkan hari aktifmu dengan yang kamu targetkan. Ari memulai tahun itu tanpa sanggup lari dua blok.',
  ...
  'tut.app-ejercicio--anio.3.texto':
    'Ruangan Target menyimpan empat targetnya yang sudah tercapai — 5K, 10K, half marathon, dan marathon — dan satu yang masih berjalan. Target dengan tanggal juga muncul di kalender MindHaOS.',
  'tut.app-ejercicio--carrera.1.titulo': 'Katalog, Rutinitas, dan Progres',
  'tut.app-ejercicio--carrera.1.texto':
    'Tiap jenis latihan tersusun sama: katalog gerakan, rutinitasmu beserta riwayatnya, dan progres. Mari mulai dari lari-lari yang sudah dijalani Ari.',
  ...
  'tut.app-ejercicio--fuerza.2.texto':
    'Pilih satu gerakan dan lihat kenaikannya: squat Ari naik dari empat puluh kilo ke tujuh puluh. Selama bulan cedera dia hanya melatih tubuh bagian atas, dan kurva itu sama sekali tidak terusik.',
  ...
  'tut.app-cocina--alimentacion.1.texto':
    'Dari berat, tinggi, dan aktivitasmu, aplikasi menghitung kebutuhan harianmu lalu membagi makronya. Ari menetapkan 2.400 kalori dan berat target yang tinggal kurang dari satu kilo lagi.',
  'tut.app-cocina--alimentacion.2.titulo': 'Langkah 2: apa yang kamu makan hari ini',
  'tut.app-cocina--alimentacion.2.texto':
    'Sarapan, makan siang, makan malam, dan camilan di sela-sela: tiap catatan mengisi cincin hari itu. Air punya targetnya sendiri, dan itulah yang dilihat MindHaOS untuk menganggap harimu tuntas.',
  ...
  'tut.app-cocina--recetario.1.texto':
    'Diet di sini adalah rencana dengan resep-resepnya di dalam. Ari menyimpan dua buatannya sendiri: minggu maraton dan pulang dari Jepang, selain yang sudah dibawa aplikasi.',
  ...
  'tut.app-descanso--noche.3.texto':
    'Riwayatnya disimpan per tahun, bulan, dan minggu. Gulir sampai bulan-bulan pertama Ari lalu bandingkan dengan yang terakhir: tidur lewat pukul satu dan cuma dapat lima jam.',
  ...
  'tut.app-despacho--anio.3.texto':
    'Rincian per kategori untuk periode yang sedang kamu lihat. Ari menulis kategorinya sendiri: aplikasi mengenali yang umum dan memberi warna tersendiri untuk sisanya.',
  ...
  'tut.app-despacho--captura.1.titulo': 'Item tetap milik Ari',
  'tut.app-despacho--captura.1.texto':
    'Sewa, internet, ponsel, langganan streaming, dan asuransi mobil: lima catatan dari bulan ke-2, saat Ari memutuskan untuk berbenah. Sejak itu masing-masing menghitung dirinya sendiri.',
  ...
  'tut.app-despacho--captura.5.texto':
    'Di MindHaOS-mu sendiri kamu juga bisa mencatat lewat chat: “belanja 250 di supermarket” dan langsung tercatat.',
  ...
  'tut.app-despacho--metas.4.texto':
    'Ari memantau yen sejak perjalanan itu diputuskan, dan sekarang won, untuk perjalanan berikutnya. Forex, Kripto, Saham, dan Komoditas secara langsung (butuh internet).',
  ...
  'tut.app-garage--vehiculos.2.texto':
    'Berapa kendaraan, berapa administrasi yang masih berjalan, dan berapa yang sudah kamu keluarkan tahun ini. Buat Ari, mobil itu mahal ongkosnya.',
  ...
  'tut.app-garage--tramites.4.texto':
    'Semua administrasi itu ada juga di kalender MindHaOS, lengkap dengan peringatan sebelumnya. Dan hati-hati: kendaraan yang kamu kemudikan di peta itu hal lain, mereka tinggal di Inventaris.',
  ...
  'tut.app-sala--japon.1.texto':
    'Satu folder per negara, lengkap dengan foto sampulnya. Di dalamnya satu kartu per tempat, dan di dalam tiap kartu: apa yang Ari tulis hari itu.',
  ...
  'tut.app-entretenimiento--archivo.2.texto':
    'Judul, penulis atau sutradara, genre, status, dan bintang. Ulasan berisi pendapat Ari, bukan ringkasan cerita: setahun lagi, hanya bagian itulah yang berguna untuknya.',
  ...
  'tut.app-diario--habito.2.texto':
    'Edisi hari itu diunduh sendiri dan tengah malam diganti seutuhnya: di sini tidak ada yang menumpuk, persis seperti koran sungguhan. Dan kalau kamu mengganti bahasa MindHaOS, persnya ikut berganti: tiap bahasa membawa medianya sendiri.',
  ...
  'tut.app-diario--habito.4.texto':
    'Ari membacanya sekitar dua ratus hari tahun ini: banyak di awal, hampir tidak pernah di bulan yang berat, dan setiap hari selama tiga minggu terakhir. Runtunannya hidup dari situ.',
