...
export const EN_TUT: Dict = {
  ...
  'tut.casa.2.texto': 'I opened it so you can see it: this is the main menu, with your rooms and their apps. Its other tabs hold the template catalog (apps) and the object inventory.',
  ...
  'tut.casa.2c.titulo': 'The inventory',
  'tut.casa.2c.texto': 'And the third: the inventory — the objects and pieces you keep from your rooms, ready to be placed again wherever you like.',
  ...
  'tut.primeros.1.texto': 'This tutorial answers two things: how to ENTER your apps and how to CREATE a new one. Both live here, in the Rooms tab.',
