  ...
  },
  {
    ...
    carpetas: [
      ...
      },
      {
        ...
        id: 'amigos',
        titulo: 'Amigos',
        nota: 'Otras personas con cuenta: elige un alias en los ajustes del menú Amigos, agrégalas por su alias y chatea con ellas ahí mismo. Dentro del chat de un amigo: «+» manda una imagen, un PDF, una foto, un audio o un video, o el contenido de un cuarto. Las órdenes de abajo se escriben tal cual en su chat (en español o en inglés): «jugar» le manda el enlace directo al juego, «enviar» le manda una receta, rutina, documento, dibujo, hoja, idea, mapa, dieta o itinerario, y «colaborar» lo invita a editar contigo un documento, dibujo, audio, video o calendario compartido. Desde el chat del asistente, añade su @alias.',
        grupos: [
          {
            id: 'abrir',
          ...
          },
          {
            id: 'jugar',
            ejemplos: [
              { frase: '[Jugar] {paintball}', en: '[Play] {paintball}' },
              { frase: '[Jugar] {4 en línea}', en: '[Play] {connect 4}' },
              { frase: '[Jugar] {ajedrez}', en: '[Play] {chess}' },
              { frase: '[Jugar] {damas}', en: '[Play] {checkers}' },
              { frase: '[Jugar] {cartas}', en: '[Play] {cards}' },
              { frase: '[Jugar] {debates}', en: '[Play] {debates}' },
              { frase: '[Jugar] {fútbol}', en: '[Play] {soccer}' },
              { frase: '[Jugar] {básquet}', en: '[Play] {basketball}' },
              { frase: '[Jugar] {tenis}', en: '[Play] {tennis}' },
          ...
          },
          {
            id: 'acciones',
            ejemplos: [
              { frase: '[Enviar]', en: '[Send]' },
              { frase: '[Enviar] {receta} {Tacos}', en: '[Send] {recipe} {Tacos}', roomId: 'cocina' },
              { frase: '[Enviar] {dieta} {Semana ligera}', en: '[Send] {diet} {Light week}', roomId: 'cocina' },
              { frase: '[Enviar] {rutina} {Piernas}', en: '[Send] {routine} {Legs}', roomId: 'ejercicio' },
              { frase: '[Enviar] {documento} {Capítulo 1}', en: '[Send] {document} {Chapter 1}', roomId: 'escritura' },
              { frase: '[Enviar] {dibujo} {Atardecer}', en: '[Send] {drawing} {Sunset}', roomId: 'arte' },
              { frase: '[Enviar] {hoja} {Presupuesto}', en: '[Send] {sheet} {Budget}', roomId: 'computo' },
              { frase: '[Enviar] {idea} {App de recetas}', en: '[Send] {idea} {Recipe app}', roomId: 'ideas' },
              { frase: '[Enviar] {mapa} {Proyecto}', en: '[Send] {map} {Project}', roomId: 'ideas' },
              { frase: '[Enviar] {itinerario} {Playa}', en: '[Send] {itinerary} {Beach}', roomId: 'sala' },
              { frase: '[Colaborar] {documento} {Capítulo 1}', en: '[Collaborate on] {document} {Chapter 1}', roomId: 'escritura' },
              { frase: '[Colaborar] {dibujo} {Atardecer}', en: '[Collaborate on] {drawing} {Sunset}', roomId: 'arte' },
              { frase: '[Colaborar] {audio} {Mi canción}', en: '[Collaborate on] {audio} {My song}', roomId: 'audio' },
              { frase: '[Colaborar] {video} {Vacaciones}', en: '[Collaborate on] {video} {Holidays}', roomId: 'video' },
              { frase: '[Colaborar] {calendario} {Familia}', en: '[Collaborate on] {calendar} {Family}' },
            ],
          },
        ],
      },
