...
const FRASES: Record<MascotaId, Record<EventoTipo, string[]>> = {
  mago: {
    ...
    agregar: ['🪄 He materializado {c} en tu MindHaOS.', '{c} aparece en el mapa por arte de magia ✨'],
    quitar: ['🪄 {c} se desvanece del mapa.', 'He retirado {c} de tu MindHaOS.'],
  ...
  perro: {
    ...
    agregar: ['¡GUAU! ¡Agregué {c} al mapa! 🎉', '¡{c} ya está en tu MindHaOS! 🐶'],
  ...
  buho: {
    ...
    agregar: ['{c} añadido al mapa.', 'He incorporado {c} a tu MindHaOS. 🦉'],
