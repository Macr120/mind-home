...
const RE_EDITOR_TEMAS =
  /\b(cuartos?|habitacion\w*|recamaras?|casa|mapa|muros?|pared\w*|pisos?|suelo|techos?|tejado|objetos?|muebles?|inventario|avatar|personajes?|ropa|prendas?|atuendos?|guardarropa|color\w*|temas?|fondo|cielo|estacion\w*|idiomas?|ingles|espanol|interfaz|botones?|menus?|paneles?|esquinas|bordes|sombras|iconos?|emojis?|tipografia|fuente|letra|apariencia|claro|oscuro|transparente|vidrio|configuracion\w*|ajustes|preferencias|notificacion\w*|avisos?|respaldo|backup|bienvenida|tutorial\w*|musica|cancion\w*|volumen|camaras?|vistas?|isometric\w*|primera persona|tercera persona|vehiculos?|coche|carro|auto|moto|tren|ovni|nave|bici\w*|wrapped|resumen|huertos?|granjas?|cultivos?|canchas?|futbol|basquet|tenis|pistas?|carreras?|montana rusa|vias?|grafiti|efectos?|animacion\w*|paintball|marcadora|bolazos?|diagrama\w*|esquemas?|venn|organigrama|lluvia de ideas|estudios?|audio|cancion\w*|melodia|piano roll|midi|dj|mezclador|dibujos?|galeria|lienzo|libros?|escritura|guion\w*|cuentos?|novelas?|videos?|clips?)\b/
