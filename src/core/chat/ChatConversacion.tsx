    ...
    <div className="ui-panel-glass mb-2 flex max-h-[55vh] flex-col rounded-2xl border border-white/10 shadow-xl backdrop-blur-md">
      ...
      <div className="flex items-center gap-2 border-b border-white/10 px-3 py-2">
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate text-sm font-semibold text-white/90">{asistente.nombre}</p>
                ...
                >
                  ...
                  <p
                    className={`mt-0.5 text-right text-[9px] ${
                      esUsuario ? 'text-emerald-200/50' : 'text-white/30'
                    }`}
                  >
        ...
        {escribiendo && (
          <div className="flex justify-start">
            <div className="rounded-2xl rounded-bl-sm bg-white/10 px-3 py-1.5 text-sm text-white/60">
              <span className="animate-pulse tracking-widest">{asistente.emoji} …</span>
            </div>
          </div>
        )}
      </div>
