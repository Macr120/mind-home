...
export function EditPanel() {
  ...
  return (
    <div data-tut-zona="editor-mapa" className="ui-panel-glass ui-desliza-fin absolute end-0 top-0 z-[35] flex h-full w-80 flex-col border-s border-white/10 pt-[var(--safe-top)] pb-[var(--safe-bottom)] pe-[var(--safe-end)] backdrop-blur-md">
