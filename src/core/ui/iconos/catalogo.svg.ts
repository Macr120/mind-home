...
export const SVGS: Record<NombreIcono, LucideIcon> = {
  ...
  medida: Ruler,
  capas: Layers,
  compas: DraftingCompass,
  fusionar: ArrowDownToLine,
  ropa: Shirt,
  perfil: User,
  esfera: Circle,
  cilindro: Cylinder,
  ...
  'lista-num': ListOrdered,
  linea: Slash,
  rectangulo: RectangleHorizontal,
  elipse: Circle,
  gotero: Pipette,
  letra: Type,
  grabar: CircleDot,
  metronomo: Music2,
  piano: Piano,
  sintetizador: SlidersHorizontal,
  vinilo: Disc3,
  iman: Magnet,
  transicion: Blend,
  acercar: ZoomIn,
