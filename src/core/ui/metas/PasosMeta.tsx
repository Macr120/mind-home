    ...
    <div style={{ paddingLeft: sangria }} className="space-y-0.5 py-0.5 pe-1">
      {meta.pasos.map((p, i) => (
        <div key={i} className="flex items-center gap-1.5">
          <button
            ...
            className={`ui-presion grid h-3.5 w-3.5 shrink-0 place-items-center rounded-lg border text-[9px] transition ${
              hechos.has(i)
          ...
          {editando === i ? (
            <input
              ...
              className="min-w-0 flex-1 rounded-lg border border-white/15 bg-black/30 px-1.5 py-0.5 text-2xs text-white/90 focus:border-accent/60 focus:outline-none"
            />
          ) : (
            <button
              type="button"
              ...
              className={`ui-presion min-w-0 flex-1 truncate text-start text-2xs text-white/70 ${
          ...
          <button
            ...
            className="ui-presion shrink-0 px-1 text-[10px] text-white/25 transition hover:text-red-400"
          >
            <Icono nombre="basura" />
          </button>
        </div>
      ...
      {agregando ? (
        <input
          ...
          className="w-full rounded-lg border border-white/10 bg-black/20 px-1.5 py-0.5 text-2xs text-white/85 placeholder:text-white/25 focus:border-accent/60 focus:outline-none"
        />
      ) : (
